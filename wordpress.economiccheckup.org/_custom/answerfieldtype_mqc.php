...
';
		...
		if ($answerfieldText == 'Client' ){
		echo '
						onChange="var objrow = document.getElementById(\'tr_esi_other_specify\'); 
	...
	case 'zipcode':
		...
		echo '
        <div class="input" id="tr_'.$answerfield.'">									
		<input type="text" pattern="[0-9]*"  maxwidth="5" id="'.$answerfield.'" size="6" autocomplete="off" minlength="5"  maxlength="5" name="'.$answerfield.'" value="'.$answerfieldValue.'" class="required"';
	//zip state js check
	...
	";
	 ...
	 //echo '">
	//	<input class="btn btn-disabled btn-small" type="button" name="zyxzip_zip_abbrev" size="2" value="" disabled="" >
	//';
	echo '	</div>
		';
        break;
