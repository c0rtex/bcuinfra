...
<form name="mqcForm" id="mqcForm" action="/please-wait/" method="post" > 
<input type="hidden" name="subset_id" value="72">
...
<div class="span4">
   	<div class="well sidebar-nav" >
        ...
        <ol class="nav nav-list">
	     ...
	     <li><a data-toggle="modal" role="button" target="_new" href="https://qa.mymedicarematters.org/get-help/glossary/"><i class="icon-book "></i> Glossary of Terms </a></li>
