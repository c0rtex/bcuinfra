         ...
         <div class="body-header" style="z-index: 999;">
       	...
       	<div class="">
         	<div action="" method="get" id="commentForm" class="well cmxform">
                ...
                <script type="text/javascript" src="/cf/js/flot/jquery.flot.canvas.js"></script>
...
canvasImgCount = 0;
																...
																sidebar.scrollToFixed({
																  ...
																  limit: $('#footer').offset().top - $(sidebar).outerHeight() - 11,
																  zIndex: 999
																});
															});
                                $(function() {
        ...
        <div class="">
			<div action="" method="get" id="commentForm" class="well cmxform">
				<?php
					...
					if (isset($AF_array[$AFrow_index]["option_code"])&&($AF_array[$AFrow_index]["option_code"] == 'n')){$money_recs[1]["show"] = 1;}
					unset($AFrow_index);
        ...
        <div class="">
        	<div action="" method="get" id="commentForm" class="well cmxform">
                <?php
					...
					//echo $AF_array[$AFrow_index3]["option_code"];
					unset($AFrow_index3);
					unset($AFrow_index4);
					unset($AFrow_index5);
					unset($req1);
					...
					if (isset($AF_array[$AFrow_index]["option_code"])&&($AF_array[$AFrow_index]["option_code"] == 'y')){$housing_recs[0]["show"] = 1;}
					unset($AFrow_index);
                ...
                <?php
                    ...
                    $health_recs = array( array('postid' => 2705, 'bcu' => 1, 'show' => 0),
						...
						array('postid' => 2701, 'bcu' => 0, 'show' => 0),
                       	array('postid' => 13533, 'bcu' => 0, 'show' => 0),
                    ...
                    {
						if (($health_recs[$row]["show"] == 1) && ($health_recs[$row]["postid"] != 2724) && ($health_recs[$row]["postid"] != 13533))                
						{
							$health_recs_count = ++$health_recs_count;
							...
							if (($health_recs[$row]["postid"] == 13533) && ((($esi_healthmonthly >= $oneFifthMthlyInc) && ($userAge >= 65)) || ($esi_counselor == 1))) {
       	...
       	<div class="">
        	<div action="" method="get" id="commentForm" class="well cmxform">
        		<?php
					...
					if((isset($AF_array[$AFrow_index]["option_code"]) && ($AF_array[$AFrow_index]["option_code"] == 'y'))){$req2 = 1;}
					if((isset($AF_array[$AFrow_index]["option_code"]) && ($AF_array[$AFrow_index]["option_code"] == 'y'))){$req3 = 1;}
					if((isset($AF_array[$AFrow_index]["option_code"]) && ($AF_array[$AFrow_index]["option_code"] == 'y'))){$req4 = 1;}
					...
					if(isset($AF_array[$AFrow_index]["option_code"]) && ($AF_array[$AFrow_index]["option_code"] == 'y')){$debt_recs[4]["show"] = 1;}
					unset($AFrow_index);
