...
require_once('soap_client_test.php');
require_once('displaycontent_mqc_4_cache.php');
//echo 'Test';
...
echo '<form name="mqcForm3" id="mqcForm3" action="/please-wait/" method="post" > ';
}


?> 
<?php  require_once('section_mqc_4_cache.php');
