...
echo $header_callout->post_content;?></p>
	...
	<div style="position:absolute; bottom:0px; padding-left:10px; padding:5px 20px 5px 20px;text-align:center;"><font color="#ED1C24"><b>Superstorm Sandy:</b> If you live in an area that was affected by Superstorm Sandy,
