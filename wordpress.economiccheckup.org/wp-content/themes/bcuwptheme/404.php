...
<meta name="msvalidate.01" content="73FAF9EF809DEE2A8BAD7758DB4A3776" />
  	...
  	<![endif]-->
  	<title>Page Not Found | EconomicCheckUp</title>
...
dataLayer = [{
	...
	<body class="page page-id-16692 page-template page-template-index-ecu-full-rev-php logged-in" data-spy="scroll" data-target=".sidebar-nav">
...
<br />
						...
						<input id="ileCancelButton-16692" type="button" value="Cancel editing"/>
<script type="text/javascript">
/* <![CDATA[ */
	jQuery("#ileLoader-16692").hide();
	jQuery("#ileSaveButton-16692").hide();
	jQuery("#ileCancelButton-16692").hide();
	jQuery("#ileLoader-16692").ajaxStart(function(){
		jQuery("#ileLoader-16692").show();
	})
	jQuery("#ileLoader-16692").ajaxStop(function(){
		jQuery("#ileLoader-16692").hide();
	})
	jQuery("#ileEditButton-16692").click(function(){
		startEditing(16692);
	})
	jQuery("#ileSaveButton-16692").click(function(){ileSave(16692,jQuery("div.nicEdit-main").html());});
	jQuery("#ileCancelButton-16692").click(function(){
		...
		jQuery.ajax({async:false,
					 ...
					 success:function(data){
						 if (data.search(/<script/i)==-1)
							jQuery("#ileContent-16692").html(data);
						else
							jQuery(location).attr("href","/page-not-found/");
					 }
					 });
		jQuery("#ileSaveButton-16692").hide();
		jQuery("#ileCancelButton-16692").hide();
		jQuery("#ileEditLink-16692").show();
	})
/* ]]&gt; */
</script>
