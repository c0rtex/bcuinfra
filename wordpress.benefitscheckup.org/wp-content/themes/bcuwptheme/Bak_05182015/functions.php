...
function rbcu_scripts_and_styles() {	
	if ( is_page_template( 'index-responsive.php' )  || is_page_template( 'index-mqc-rev.php' ) || is_page_template( 'index-ecu-rev.php' ) || is_page_template( 'index-ecu-full-rev.php' ) || is_page_template( 'index-ecu-alt-rev.php' )) {
		// bootstrap js
