...
find over <strong>$1.1 billion</strong> in SNAP benefits.</p>
       <!--<img src="/wp-content/uploads/2014/07/logo_snap_walmart.gif" title="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" alt="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" style="float: right;"/> -->
       <img src="/cf/img/partners/seniorhunger/logo.gif" title="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" alt="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" style="float: right; padding-top: 20px;"/>
        <div id="sponsors">
	...
	<!-- ?php
		$page = $post->ID;
		if ($page == 1673 ){
			echo "<div style='position:absolute; bottom:0px;width:100%;text-align:center;'><b style='color:#ED1C24;font-weight:bold;'><a style='color:#ED1C24;font-weight:bold;' class='Warning'  href='/home/disaster-assistance'>Oklahoma Tornado Relief</a>:</b><font> Find <a href='/home/disaster-assistance'>disaster recovery aid</a> for food, shelter, utilities, and more!</font>  </div>";}
