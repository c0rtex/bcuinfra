	...
	<body data-spy="scroll" data-target=".sidebar-nav">
		...
		<div class="container-fluid">
            ...
            <div id="header" class="row-fluid">
                <div class="span5" >
                	<a href="/esi-home" class="block">                  <img src="/wp-content/uploads/2013/08/EconomicCheckUp_NCOA_small.jpg" title="EconomicCheckUp - A Holistic Approach to Helping Older Adults in Need" alt="EconomicCheckUp" id="logo"/></a><br><BR>
              	</div>
		...
		?>
		    ...
		    <li id="esi-help" class="span2"><a href="/esi-find-help" class="<?php echo $_help; ?>">Resources</a></li>
