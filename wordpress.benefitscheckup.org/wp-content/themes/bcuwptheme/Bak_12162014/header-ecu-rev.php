	...
	<div class="container" id="header">
    	<div class="row-fluid">    
    		<div id="header_logo" class="span5">
	              <a href="/esi-home/"><img src="/wp-content/uploads/2013/08/EconomicCheckUp_NCOA_small.jpg" title="EconomicCheckUp - A Holistic Approach to Helping Older Adults in Need" alt="EconomicCheckUp"  /></a>                  
	     	</div>
     ...
     <div class="container navbar" id="main-nav">
		...
		<div id="main-nav" class="navbar row-fluid">
                ...
                <?php // insert wp_menu_nav here  ?>
                    ...
                    <li><a href="/esi-questions" <?php if (is_page("esi-questions")) echo "class='current'"; ?>>Get&nbsp;Started</a></li>
