	        ...
	        <div class="container" >
				<div id="main-nav" class="navbar row-fluid">
		           ...
		           <?php // insert wp_menu_nav here  ?>
		               <li><a href="/" <?php if (is_front_page()) echo "class='current'"; ?>>Home</a></li>
		               <li><a href="/find-help" <?php if (is_page("find-help")) echo "class='current'"; ?>>Find Help</a></li>
		               <li><a href="/about-us" <?php if (is_page("about-us")) echo "class='current'"; ?>>About Us</a></li>	
		               <li><a href="/our-sponsors" <?php if (is_page("our-sponsors")) echo "class='current'"; ?>>Our Sponsors</a></li>				
		               <li><a href="/news" <?php if (is_page("news")) echo "class='current'"; ?>>News</a></li>
