...
<head>
    ...
    <script type="text/javascript"
            src="<?php echo $dev_url; ?>/wp-content/themes/bootswatch/bootstrap/js/jquery.validate.js"></script>
    <!--			      <script type="text/javascript" src="<?php echo $dev_url; ?>/wp-content/themes/bootswatch/bootstrap/js/bootstrap.js"></script> -->
    <script type="text/javascript"
            src="<?php echo $dev_url; ?>/wp-content/themes/bootswatch/bootstrap/js/scrolltofixed.js"></script>
    ...
    <link href="<?php echo get_stylesheet_directory_uri() ?>/responsive/css/bootstrap.min.css" rel="stylesheet"
          type="text/css">
...
<div class="container" id="top-bar">
    <div class="row">
        <div id="top-logo" class="span12">
            <a target="_blank" href="http://www.ncoa.org"><img
                    src="<?php echo get_template_directory_uri(); ?>/images/ncoa-logo-top.png"
                    alt="National Council on Aging" title="National Council on Aging" alt="National Council on Aging"/></a>
        </div>
    </div>
</div>
...
<div class="container" id="header">
    <div class="row-fluid">
        <div id="header_logo" class="span5">
            <a href="/" class="block"><img src="<?php echo get_template_directory_uri(); ?>/images/logos/bcu.png"
                                           title="BenefitsCheckUp" alt="BenefitsCheckUp"/>
                <!--<img src="/wp-content/uploads/2011/11/bcu_10th-anni-logo.png" title="BenefitsCheckUp" alt="BenefitsCheckUp" />-->
            </a>
        </div>

        <?php if (is_page('getsnap')) { ?>
            <div class="span7 statistics" id="logo"><p style="font-size: 0.75em;"><img
                        src="/cf/img/partners/seniorhunger/logo.gif"
                        title="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation"
                        alt="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" align="right">We
                    have helped more than <strong>1 million people</strong>
                    find over <strong>$1.1 billion</strong> in SNAP benefits.</p>
            </div><?php } else { ?>
            <div class="span5 statistics" id="logo">
            ...
            <div class="container">
                <div id="main-nav" class="navbar row-fluid">
                    <ul id="home-nav" role="navigation">
                        ...
                        <li>
                            <a href="/?sc_partner_id=<?php echo $scPartnerIdVar; ?>" <?php if (is_front_page()) echo "class='current'"; ?>>Home</a>
                        </li>
                        <li>
                            <a href="/find-help?sc_partner_id=<?php echo $scPartnerIdVar; ?>" <?php if (is_page("find-help")) echo "class='current'"; ?>>Find
                                Help</a></li>
                        <li>
                            <a href="/about-us?sc_partner_id=<?php echo $scPartnerIdVar; ?>" <?php if (is_page("about-us")) echo "class='current'"; ?>>About
                                Us</a></li>
                        <li>
                            <a href="/our-sponsors?sc_partner_id=<?php echo $scPartnerIdVar; ?>" <?php if (is_page("our-sponsors")) echo "class='current'"; ?>>Our
                                Sponsors</a></li>
                        <li>
                            <a href="/news?sc_partner_id=<?php echo $scPartnerIdVar; ?>" <?php if (is_page("news")) echo "class='current'"; ?>>News</a>
                        </li>
