	...
	<body data-spy="scroll" data-target=".sidebar-nav">
          ...
          jQuery.ajax({
            ...
            success: function(StateId){
              ...
              if(!newcode || StateId == 'false'){
              	stcode = '';
                stname = '';
                $('#esi_zip').before('<div class="alert alert-danger"><i class="icon-warning-sign"></i> This is an invalid ZIP code.  Please try again.</div>');
		...
		<div class="container-fluid">
            ...
            <div id="header" class="row-fluid">
                <div class="span5" >
                	<a href="http://www.ncoa.org/enhance-economic-security/economic-security-Initiative/" target="_new" class="block">                  <img src="/cf/img/ecu_ncoa_small_beta.gif" title="EconomicCheckUp - A Holistic Approach to Helping Older Adults in Need" alt="EconomicCheckUp" id="logo"/></a><br><BR>
              	</div>
