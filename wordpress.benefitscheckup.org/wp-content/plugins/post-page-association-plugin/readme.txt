...
* Deze Plugin is beschibaar in het Nederlands. ([Frank Devocht](http://www.devocht.com/))
* Acest plugin este disponibil în limba Română. ([Anunturi Jibo](http://www.jibo.ro/))
* Ovaj dodatak je dostupan na hrvatskom jeziku. ([Barbara Vlahovic](http://smijesne.com))
...
= 1.3.22 =
* Fixed Add_Meta_Box to work with WordPress 3.2

= 1.3.21 =
* Added Croatian translation by [Barbara Vlahovic](http://smijesne.com).

= 1.3.20 =
* Works with Child themes now

= 1.3.19 =
* Small Meta Box modifications.
...
= 1.3.16 =
* Added a new "orderby" option.
* Added 'ignore_sticky_posts' key to WP_Querys.

= 1.3.15 =
* Small changes in the constructor.

= 1.3.14 =
* Added Romanian translation by [Anunturi Jibo](http://www.jibo.ro/).

= 1.3.13 =
* Added Dutch translation by [Frank Devocht](http://www.devocht.com/).


= 1.3.12 =
* Removed all hard coded Style links (changed to wp_enqueue_style)
