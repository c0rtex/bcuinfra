...
<div id="association-selection">
  ...
  <p class="order-by">
    ...
    <select name="<?php Echo $this->Field_Name('order_by') ?>">
      ...
      <option value="" <?php Selected($meta['order_by'], 'meta_value') ?> disabled="disabled"><?php Echo $this->t('Meta Value &mdash; Only available in the Pro Version.') ?></option>
    </select>
  </p>
  ...
  <div class="template">
    <?php ForEach ( (Array) $this->find_templates() AS $file => $properties ) : ?>
    <p>
