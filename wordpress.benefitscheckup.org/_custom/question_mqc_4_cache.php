...
//echo 	$questionHelpText;						
    echo'
									<a data-content="'.$helpText.'" title="'.$helpTitle.'" data-html="true"  data-toggle="popover" href="#" data-original-title="Help"><i class="icon-question-sign icon-large sally3"></i></a>
';
endforeach;
echo'									</label>';
require('questiontype_mqc_4_cache.php');
