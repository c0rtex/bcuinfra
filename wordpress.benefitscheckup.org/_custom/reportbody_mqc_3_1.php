...
//append to mmm url link if tracking parameters were created from links
...
$ws_click_id = $affinityClient->logAffinityClick(0,'',0,0,0,0,$screeningID,$_GET['click_id']);
//echo $ws_click_id;
$appendurl = '';
//echo "click:".$_GET['click_id'];
...
//this string is added to AHN links
$appendurl = '&PID='.$_SESSION['PID'].'&CID='.$_SESSION['CID'].'&click_id='.$_SESSION['click_id'];
...
and screening_id = $screeningID and subset_content.subset_id='75' 
order by sort_order
limit 10
";
...
and subset_content.subset_id='75'
...
*/
 ...
 ga('send', 'event', 'mqc', 'MQC Results Page (Request AON Button)', 'resultsreqbtn'); ga('mmm.send', 'event', 'mqc', 'MQC Results Page (Request AON Button)', 'resultsreqbtn'); ".'" ><img src="/wp-content/uploads/2014/06/Phone_60x60.png" alt="Request a Phone Appointment" title="Request a Phone Appointment"> Request a Phone Appointment</a>
					...
					$transitiontext = '<a href="https://www.benefitscheckup.org/carriers/'.$page_template.'">Click here</a>';
...
onClick="ga('send', 'event', 'mqc', 'MQC Results Page (Request AON Link)', 'resultsreqrr'); ga('mmm.send', 'event', 'mqc', 'MQC Results Page (Request AON Link)', 'resultsreqrr');"
	<?php echo' href="/cf/redirect.cfm?id=51&tgt=1&partner_id=14&visible=false&'.$reportkey.$appendurl.'" onClick="javascript:aonFloodlightRequestLink();" >Request</a> a telephone appointment with a licensed insurance agent to help
