...
seniors. 
<a data-toggle="modal" role="button" href="#gettingstarted" href="/wp-content/uploads/2013/07/ECU-ChecklistV2.pdf">Before you start, see a list of information you will need</a>.
</p>
</div>
...
<div class="span4" style="margin-top: 60px; margin-left: 12px;">
   	<div class="well sidebar-nav" >
        ...
        <ol class="nav nav-list">
            ...
            <li><a href="/wp-content/uploads/2014/11/EconomicCheckUp-Financial-Worksheet.pdf" target="_blank"> <i class="icon-book "></i>Financial Worksheet</a></li>
	    
            <li><a data-toggle="modal" role="button" target="_new" href="https://redesign.benefitscheckup.org/wp-content/uploads/2014/03/ECU-Printable-Assessment.pdf"><i class="icon-print"></i>Get
...
<p>We have found that having the necessary information at your fingertips makes completing the questions easier. You will need to know the following about yourself or about the person you are helping:</p>
<ul>
<li>Zip code</li>
<li>Date of birth</li>
...
<li>Estimates of current income and assets from all sources for self, spouse and others in the household</li>
