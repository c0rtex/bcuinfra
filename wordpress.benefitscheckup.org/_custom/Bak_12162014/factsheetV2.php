...
';
 ...
 if(isset($screeningID)){echo '            <li><a data-toggle="modal" role="button" href="/esi-results?screeningID='.$screeningID.'&shadowID='.$shadowID.'"><i class="icon-circle-arrow-left "></i> Back to Results </a></li>';
 }
echo '
        </ol>		
    </div>	  
