...
//echo "<br/>";
//echo $emailV;
if ($phoneV != false && $emailV != false && $emailV != "emailMismatch" && $_POST["first_name"] != "" && $_POST["last_name"] != "" && $confirmphoneV != false){ 
...
if(!$db->ssl_set('/opt/bcu/etc/ssl/mysql/client-key.pem','/opt/bcu/etc/ssl/mysql/client-cert.pem',NULL,NULL,NULL)){
