...
<p>FINAL TEXT COMING - Below is the program list based on the categories you stated you were interested in getting information about. Click on the name of each program below to get a fact sheet that contains: a program description, local contact information, a list of the paperwork you might need to apply for the program, and an application form (if available). Not all programs have application forms available to download.</p>

Want to dig deeper? Take <A HREF="http://www.benefitscheckup.org"target="_blank">BenefitsCheckUp</A> to get a customized report for your individual situation. 
<?php
...
?>
	<section id="programlist">  	
        <div class="body-header-wrapper">	<h2><i class="icon-money "></i>  Your Program List </h2>	
