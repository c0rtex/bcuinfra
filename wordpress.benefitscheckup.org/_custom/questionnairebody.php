...
<div class="span4" style="margin-top: 60px; margin-left: 12px;">
   	<div class="well sidebar-nav" >
        ...
        <ol class="nav nav-list">
            ...
            <li><a data-toggle="modal" role="button" target="_new" href="https://www.benefitscheckup.org/wp-content/uploads/2014/03/ECU-Printable-Assessment.pdf"><i class="icon-print"></i>Get
