...
class SingleApplicantCT
{
    var $pages = array( array('PAGEID'=> 'Ee001', 'PAGEOCCURRENCE'=> 1, 'PAGESETID'=> '', 'PAGESETOCCURRENCE'=> 0, 'ACTION.START'=> 'Apply+Now'), 
                        ...
                        array('PAGEID'=> 'Mc001', 'PAGEOCCURRENCE'=> 1, 'PAGESETID'=> '', 'PAGESETOCCURRENCE'=> 0, 'ACTION.CONTINUE'=> 'Next',
                      		  ...
                      		  'BE_THRD_PHNEXCH'=>'',  'BE_THRD_PHNNUM'=>'', 'CT_THRD_PHONE'=>'', 'BE_THRD_ADDRLN_1'=>'',  'BE_THRD_ADDRLN_2'=>'',  
                      		  'BE_THRD_ADDRLN_3'=>'', 'BE_THRD_ADDRLN_4'=>'','BE_THRD_ADDR_CITY'=>'', 'CT_THRD_ADDR_ST_GRT'=>'', 'BE_THRD_ADDR_ZIP5'=>'',
                         	  'BE_CLNT_FNM'=>'', 'BE_CLNT_MNM'=>'', 'BE_CLNT_LNM'=>'', 'BE_CLNT_SFX'=>'', 'CT_CLNT_COSSN'=>'', 'BE_CLNT_WRKD_L2YR_XND'=>'', 'BE_WH_APPLY'=>'', 'BE_SAV_LMT_XND'=>'', 'BE_SEND_MSPINFO_CD'=>'', 
                              'BE_NONCL_FNM'=>'', 'BE_NONCL_MNM'=>'', 'BE_NONCL_LNM'=>'', 'BE_NONCL_SFX'=>'', 'CT_NONCL_COSSN'=>'', 
                              'BE_NONCL_WRKD_L2YR_XND'=>'', 'BE_CLNT_CHG_ADDR_SW'=>'', 'BE_CLNT_MAIL_ADDRLN_1'=>'',  'BE_CLNT_MAIL_ADDRLN_2'=>'',                              
                              'BE_CLNT_MAIL_ADDRLN_3'=>'','BE_CLNT_MAIL_ADDRLN_4'=>'', 'BE_CLNT_MAIL_ADDR_CITY'=>'', 'CT_CLNT_MAIL_ADDR_ST_GRT'=>'', 'BE_CLNT_MAIL_ADDR_ZIP5'=>'', 'BE_CLNT_PHNAREA'=>'',                              
                              'BE_CLNT_PHNEXCH'=>'', 'BE_CLNT_PHNNUM'=>'', 'BE_CNTCT_FNM'=>'', 'BE_CNTCT_LNM'=>'', 'BE_CNTCT_PHNAREA'=>'', 'BE_CNTCT_PHNEXCH'=>'',
                              'BE_CNTCT_PHNNUM'=>'', 'CT_CNTCT_PHONE'=>'', 'CT_CLNT_PHONE'=>'', 'BE_CLNT_DOB_MONTH'=>'','BE_CLNT_DOB_DAY'=>'','BE_CLNT_DOB_YEAR'=>''),                                                                                                               
						...
						array('PAGEID'=> 'Mc005', 'PAGEOCCURRENCE'=> 1, 'PAGESETID'=> '', 'PAGESETOCCURRENCE'=> 0, 'ACTION.CONTINUE'=> 'Next',
                              ...
                              'BE_NONCL_OTH_INCM_AMT'=>'', 'BE_NONCL_OTH_INCM_TYP'=>'', 'BE_INCM_DECRS_XND'=>'', 'BE_CLNT_SS_BENEFITS_XND'=>'', 'BE_CLNT_SS_BENEFITS_AMT'=>''),
 		
                        array('PAGEID'=> 'Mc004', 'PAGEOCCURRENCE'=> 1, 'PAGESETID'=> '', 'PAGESETOCCURRENCE'=> 0, 'ACTION.CONTINUE'=> 'Next',
 							  'BE_CLNT_EARN_WGS_XND'=>'', 'BE_CLNT_EARN_WGS_AMT'=>'', 'BE_CLNT_EARN_LOSS_XND'=>'', 'BE_CLNT_EARN_AMT'=>'',                                                                                                         
 							  'BE_WGS_DECRS_XND'=>'', 'BE_CLNT_STOP_WRK_XND'=>'', 'BE_CLNT_STOP_WRK_MONTH'=>'', 
 							  'BE_CLNT_STOP_WRK_YEAR'=>'','BE_CLNT_PAY_DISBLTY_XND'=>'', 'BE_CLNT_WRKD_L2YR_XND'=>'', 'BE_NONCL_WRKD_L2YR_XND'=>''),   
                        ...
                        array('PAGEID'=> 'Rs003', 'PAGEOCCURRENCE'=> 1, 'PAGESETID'=> '', 'PAGESETOCCURRENCE'=> 0, 'ACTION.SUBMIT'=> 'Submit+Now',
                              'BE_THRD_SUB_SW'=>'', 'BE_CLNT_SUB_SW'=>'') );
               
    function SingleApplicantCT()
    {
    ...
    function thirdParty($CT_THRD_PTY_XND)
   	{ 
  		if($CT_THRD_PTY_XND == 0)
   		{ 
    ...
    function wagesEarning($BE_CLNT_WRKD_L2YR_XND,$BE_CLNT_PAY_DISBLTY_XND,$BE_CLNT_DOB_YEAR)
    {
    	if($BE_CLNT_WRKD_L2YR_XND == 0) //skip the wages and earnings page
    	{    	    		
    		unset($this->pages[9]);    		
		}
		
		//ONLY INCLUDE IF BE_CLNT_WRKD_L2YR_XND = 'Y' AND APPLICANT AGE >= 65 (LOOK AT BE_CLNT_DOB FIELDS):
		//BE_CLNT_PAY_DISBLTY_XND
		

    	//if($BE_CLNT_UNDER_AGE_XND == 0) //remove BE_CLNT_PAY_DISBLTY_XND and BE_NONCL_PAY_DISBLTY_XND questions from wages and earnings page
    	//{     		    	  
