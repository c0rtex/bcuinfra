...
<cfparam name="attributes.var" type="string" default="">
	...
	<cfelse>
		...
		<cfif urlinfo.active_flag eq 1>
			...
			<cf_sessionPassVars href="/redirect.cfm" extralist="id=#urlinfo.url_id#,tgt=#bruTargetFlag##extra#" class="#bruClass#" id="#bruID#" target="#bruTarget#" onClick="#attributes.onClick#" var="outstr"><cfoutput>#bruText#</cfoutput></cf_sessionPassVars>
		<cfelse>
