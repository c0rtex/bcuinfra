...
<!--- ADDED by moneil 12/3/2010: Bug 5799 - Entrypoints for screening is not wrapping correctly, missing spaces, and have different font size/style --->
<cfif cgi.SCRIPT_NAME CONTAINS '/frmDetails.cfm'>
...
<cfsilent>
	...
	<cfloop list="astra,atlantic,kaiser,pfizer,cvs,coventry,wellpoint,unicare,humana,caring,bofa,aoa,sanofiaventis,ils,care,novonordisk,weinberg,unitedhealthcare" index="i">
		<cfsavecontent variable="img">
		<cf_displayimage code="img_partners_logo_#i#_gif" hspace="0" vspace="0">
		</cfsavecontent>
		<cfset a1 = findnocase('alt="', img)>
		<cfset a2 = findnocase('"', img, a1 + 5)>
		<cfset a3 = mid(img, a1 + 5, a2 - a1 - 5)>
		
		<cfset x = ArrayAppend(ImgArray, "/img/partners/logo_#i#.gif~#a3#")>
		<cfset xv = xv + 1>
	</cfloop>
...
<cfelse>
	<cfif attributes.showmenu IS 1 AND wrapper.wrapper_as_of IS 1>
		<div class="topheader">
	<cfelse>
		<div class="topheader2">
	</cfif>
...
<cfif session.org_id GT 1>
	<cfif showmenu IS 1 AND wrapper.wrapper_menu IS 1>
		<cf_sessionpassvars href="/index.cfm">
...
<cfelse>
	<cfif link IS NOT "" OR session.org_id IS NOT 0 OR (session.partner_id IS 19 AND attributes.showmenu IS 0)>
		<cf_displayimage code="img_bculogo_gif">
	<cfelse>
		<cfif attributes.showmenu IS 1 AND wrapper.wrapper_menu IS 1>
...
<cfif attributes.show_title IS "yes" AND attributes.content_title_override IS "">
	<cfswitch expression="#session.subset_id#">
		...
		<cfcase value="35"><div class="contenttitle"><h1 class="title">SNAP/Food Stamps, Housing and Energy Assistance</h1></div></cfcase>
...
<tr>
<cfif attributes.show_left_col IS 'y' AND wrapper.wrapper_left_col IS 'y'>
	<td valign="top" class="clients" width="150">
	<cf_displayimage code="img_left#randimage#_jpg">
	<h3 class="clientsh3">What People Are Saying...</h3>
	<blockquote><cf_displayquote action="random"></blockquote>
    <style type="text/css">
		##adContainer a {text-decoration:none; !important}
	</style>
    <div id="adContainer">
		<script type='text/javascript'>
        <!--//<![CDATA[
           var m3_u = (location.protocol=='https:'?'https://d1.openx.org/ajs.php':'http://d1.openx.org/ajs.php');
		   //var m3_u = "http://d1.openx.org/ajs.php";
           var m3_r = Math.floor(Math.random()*99999999999);
           if (!document.MAX_used) document.MAX_used = ',';
           document.write ("<scr"+"ipt type='text/javascript' src='"+m3_u);
           document.write ("?zoneid=<cfif CGI.HTTP_HOST CONTAINS "ssl" OR CGI.HTTP_HOST CONTAINS "www">86002<cfelse>95022</cfif>");
