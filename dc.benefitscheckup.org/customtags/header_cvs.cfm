...
<cfif link IS NOT "" OR session.org_id IS NOT 0 OR (session.partner_id IS 19 AND attributes.showmenu IS 0)><cfelse>
	...
	<cfif attributes.showmenu IS 1>
		<div class="asof1">
		<a href="http://www.cvs.com" target="www.cvs.com" target="cvs"><img src="/img/partners/cvs/logo.gif" alt="#partnerQuery.wrapper_logo_alt_text#" title="#partnerQuery.wrapper_logo_alt_text#" border="0" style="margin:24px 0px 0px 0px;"></a>
