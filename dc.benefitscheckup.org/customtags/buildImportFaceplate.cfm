...
<cfif attributes.title neq ''>
	...
	<cfif IsDefined('ThisTag.AssocAttribs')>
		...
		<cfif isDefined("fileUpload")>
			...
			<cffile action="upload" fileField="fileUpload" destination="#dest#" accept="application/csv,text/comma-separated-values,text/csv,application/msexcel,application/excel,application/vnd.ms-excel,application/vnd.msexcel,text/anytext,application/octet-stream" nameConflict="overwrite">
