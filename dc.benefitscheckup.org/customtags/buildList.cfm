...
<cfloop list="#columnNameList#" index="column">
	...
	<cfif Evaluate("colhash.columns.#column#.display") eq 'display'>
		...
		<cfset tagColumnList = ListAppend(tagColumnList, "dl#displayCount#.display_text as #column#_disptext,substring(dl#displayCount#.display_text, 1, 255) as #column#_dispsort")>
		<cfif joinType eq 'inner'>
			<cfset extraTableList = extraTableList & " #joinType# join `display_language` dl#displayCount# on #colhash.tag#.#column#=dl#displayCount#.display_id 
                        inner join `language` l#displayCount# on dl#displayCount#.language_id=l#displayCount#.language_id">
			<cfif extraWhere eq ''>
		...
		<cfelse>
			<cfset extraTableList = extraTableList & " #joinType# join  view_display_text dl#displayCount# on #colhash.tag#.#column#=dl#displayCount#.display_id">
		</cfif>
	<cfelseif Evaluate("colhash.columns.#column#.display") eq 'text'>
		<cfset tagColumnList = ListAppend(tagColumnList, "substring(#colhash.tag#.#column#, 1, 255) as #column#_dispsort")>
			...
			<cfif attributes.view>
				<cfif attributes.viewcondition eq '' Or Evaluate("#attributes.viewcondition#")>
					<cfif attributes.viewlink eq ''>
						...
						<cfset link = "#attributes.code#view.cfm?#idFields##passanchorname#">
					<cfelse>
