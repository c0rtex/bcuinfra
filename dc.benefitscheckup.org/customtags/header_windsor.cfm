...
<cfif Find("index.cfm", BasePath) or Find("before_you_start.cfm", BasePath)>
	<cfset title="BenefitsCheckUp for Windsor Medicare Extra  - NCOA's Online Screening Service">
	<cfset AddBanner = "Yes">
<cfelse>
	<cfset title="BenefitsCheckUp for Windsor Medicare Extra">
	<cfset AddBanner="No">
</cfif>
<!-- set table values -->
<cfset tablewidth="95%">
...
<cfif Find("index.cfm", BasePath) or Find("before_you_start.cfm", BasePath)>
	<cfparam name="title" default="BenefitsCheckUp for Windsor Medicare Extra - NCOA's Online Screening Service">
	<cfset AddBanner = "Yes">
<cfelse>
	<cfparam name="title" default="BenefitsCheckUp for Windsor Medicare Extra">
	<cfset AddBanner="No">
</cfif>
...
<!-- Style sheets start -->
<link rel=stylesheet href="/css/windsor.css" type="text/css" media="screen" />
...
<cfif session.org_id GT 1>
	<cfif showmenu IS 1>
		<cf_sessionPassVars href="/index.cfm"><img src="/img/bculogo.gif"  alt="BenefitsCheckUp"></cf_sessionPassVars>
	<cfelse>
		<img src="/img/bculogo.gif" alt="BenefitsCheckUp">
	</cfif>
<cfelse>
	<cfif link IS NOT "" OR session.org_id IS NOT 0 OR (session.partner_id IS 19 AND attributes.showmenu IS 0)>
		<img src="/img/bculogo.gif" alt="BenefitsCheckUp">
...
<cfif link IS NOT "" OR session.org_id IS NOT 0 OR (session.partner_id IS 19 AND attributes.showmenu IS 0)><cfelse>
	...
	<cfif attributes.showmenu IS 1>
		<div class="asof1">
		<span class="asofh2"><a href="http://www.windsorextra.com" target="Windsor"><img src="/img/partners/windsor/logo.gif" border="0" alt="Windsor Medicare Extra"></a>
		</span>
		</div>
