...
<cfif Attributes.Records GT Caller.RecordsToDisplay>
	<CFIF Caller.SR LT Caller.RecordsToDisplay>
		<CFELSE>
			...
			<A HREF="#Attributes.ThisPageName#?SR=#BackUp##Attributes.ExtraURL#"><FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#">Previous #Attributes.RecordsToDisplay# #Attributes.DisplayText#s</FONT></A>
			<cfif Attributes.UseBold IS "Yes"></B></cfif>
		...
		<CFSET FORWARD = (Caller.SR + Caller.RecordsToDisplay)>
			<CFIF StartRowB GT Attributes.Records>
				...
				<CFIF StartRowA IS StartRowB>
					...
					<NOBR><FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#">Next #Attributes.DisplayText#</FONT></NOBR></A>
					<cfif Attributes.UseBold IS "Yes"></B></cfif>
				<CFELSE>
					<cfif Attributes.UseBold IS "Yes"><B></cfif>
					<A HREF="#Attributes.ThisPageName#?SR=#Forward##Attributes.ExtraURL#">
					<NOBR><FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#">Next #LastRecords# #Attributes.DisplayText#s</FONT></NOBR></A>
					<cfif Attributes.UseBold IS "Yes"></B></cfif>
				</CFIF>
			<CFELSE>
				<cfif Attributes.UseBold IS "Yes"><B></cfif>
				<A HREF="#Attributes.ThisPageName#?SR=#Forward##Attributes.ExtraURL#">
				<FONT Face="#Attributes.DisplayFont#" SIZE="#Attributes.FontSize#"">Next #Attributes.RecordsToDisplay# #Attributes.DisplayText#s</FONT></A>
				<cfif Attributes.UseBold IS "Yes"></B></cfif>
			</CFIF>
	<CFELSE>
			<cfif Attributes.UseBold IS "Yes"><B></cfif>
