...
<script type="text/javascript" src="https://assets.aarp.org/aarp.org_/js/lib/scriptaculous/prototype.js"></script> 
...
<div class="print">
	...
	<div style="clear:left; height:0px; line-height: 0px;"></div>
		...
		<div class="topheader">
			...
			<cfif wrapper.wrapper_logo IS NOT "">y
			...
			<div class="logo" style="margin-top: #val(partnerQuery.wrapper_logo_margin_top)#; margin-right: #val(partnerQuery.wrapper_logo_margin_right)#;">
				<cfif trim(partnerQuery.wrapper_link) IS NOT ""><a href="#partnerQuery.wrapper_link#" target="#partnerQuery.wrapper_id#"><img src="#partnerQuery.wrapper_logo#" border="0" alt="#partnerQuery.wrapper_logo_alt_text#"></a><cfelse><img src="#partnerQuery.wrapper_logo#" border="0" alt="#partnerQuery.wrapper_logo_alt_text#"></cfif>
			</div>
			</cfif>
