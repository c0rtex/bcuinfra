...
<cfif session.partnerPDFLogoFlag and StructKeyExists(application.partnervars, "p#session.partner_id#") and FileExists(ExpandPath("/img/partners/#StructFind(application.partnervars, "p#session.partner_id#")#/logo.gif"))>
<center><IMG src="http://#application.serverPath#/img/partners/#StructFind(application.partnervars, "p#session.partner_id#")#/logo.gif" border="0" ALT="Logo"></center><br /><br /><br /><br /><br /><br />
<cfelseif session.partner_id eq 22 and session.partnerPDFLogoFlag>
<center><IMG src="http://#application.serverPath#/images/logo_print_aarpfound2.jpg" width="239" height="80" border="0" ALT="AARP Foundation"></center><br /><br /><br /><br /><br />
<cfelseif session.partner_id eq 28 and session.partnerPDFLogoFlag>
<center><IMG src="http://#application.serverPath#/images/logo_print_windsor.gif" width="205" height="60" border="0" ALT="Windsor Medicare Extra"></center><br /><br /><br /><br /><br /><br />
<cfelseif session.partner_id eq 30 and session.partnerPDFLogoFlag>
<center><IMG src="http://#application.serverPath#/images/logo_print_coventry.gif" width="205" height="60" border="0" ALT="Coventry Healthcare Logo"></center><br /><br /><br /><br /><br /><br />
</cfif>
...
<IMG src="http://#application.serverPath#/images/ncoa-textlogo-ffffff.gif" border="0" width="137" height="60"></CENTER><BR><cfif attributes.localversion neq "cookcountyillinois"></cfif>
