...
<cf_buildList title="Zip Codes in State" table="zip" code="zip" condition="z.state_id='#id#' and z.valid=1" by="#by#" dir="#dir#" page="#page#" rows="#rows#" edit="false" selflink="true" selflinkid="#id#">
