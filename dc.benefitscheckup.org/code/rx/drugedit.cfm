...
<cfparam name="brand_id" type="numeric" default="0">
<cfif brand_id neq 0 and id eq 0>
	<cfset id=brand_id>
</cfif>
...
<cf_buildView table="answerfield" code="drug" key="#id#" action="#action#" saving="#saving#" title="Brand-Name Medication" actionurl="drugedit.cfm" viewurl="drugview.cfm?brand_id=#id#" redirect="drugview.cfm?brand_id=#id#">
	...
	<cf_buildViewProperty column="display_id" input="display" rows="4" group="rx" namefrom="answerfield" codefrom="answerfield">
