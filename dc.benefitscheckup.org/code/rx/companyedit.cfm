...
<cfparam name="company_id" type="numeric" default="0">
<cfif company_id neq 0 and id eq 0>
	<cfset id=company_id>
</cfif>
...
<cf_buildPage title="Rx Company Administration" section="rx"><cfoutput>

<cf_buildView table="answerfield" code="drugcompany" key="#id#" action="#action#" saving="#saving#" title="Rx Company" actionurl="companyedit.cfm" viewurl="companyview.cfm?company_id=#id#" redirect="companyview.cfm?company_id=#id#">
	...
	<cf_buildViewProperty column="display_id" input="display" rows="4" group="rxco" namefrom="answerfield" codefrom="answerfield">
