...
<cf_buildView title="Abbreviated Subset Data" table="subset" code="subset" key="#id#" action="view" extraurllist="null,subsetdiff.cfm?id=#id#,subsetquestions.cfm?id=#id#" extranamelist="programs,helpers,app&nbsp;questions" linkallactions="true">
...
<cf_buildList title="Base Programs in Subset" table="program" code="program" order="sort" by="#by#" dir="#dir#" page="#page#" rows="#rows#" crosstable="view_subset_program_base" crosscolumn="subset_id" crossvalue="#id#" joincolumn="program_id" crossorder="program_id" crossadd="false" crossdelete="false" crossorderlinks="true" linksection="program" selflink="true" selflinkid="#id#">
