...
<cf_buildOrder name="#name#" table="subset_content" code="subset_content" ordercolumn="sort_order" order="sort_order" condition="subset_content.section_code='mqc1'" crosstable="subset_content" crosstag="subset_content" crosskey="post_code" crosscolumn="post_code" crosscondition="x.post_code=subset_content.post_code and subset_content.section_code='mqc1' and x.section_code='mqc1'" saving="#saving#" title="Subset Content (Recommendations) Order: MQC1 recs" redirect="subsetview.cfm?id=#id#">
