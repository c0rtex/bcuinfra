...
<cf_buildOrder name="#name#" table="subset_content" code="subset_content" ordercolumn="sort_order" order="sort_order" condition="subset_content.section_code='consumer_recs' " crosstable="subset_content" crosstag="subset_content" crosskey="post_code" crosscolumn="post_code" crosscondition="x.post_code=subset_content.post_code" saving="#saving#" title="Subset Content (Recommendations) Order: ESI consumer recs" redirect="subsetview.cfm?id=#id#">
