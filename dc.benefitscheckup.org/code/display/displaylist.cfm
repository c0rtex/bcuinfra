...
<cfquery name="counts" datasource="#session.datasrc#">
	...
	<tr bgcolor="#application.color.display.light#">
		...
		<td align="center" valign="middle" bgcolor="#application.color.display.med#"><b>#basic#</b></td>
			<cfelse>
				...
				<cfif total>
		<td align="center" valign="middle"><i><a href="xlategroup.cfm?displaygroup_id=#dd#&language_id=#language_id#">#total#</a></i></td>
				<cfelse>
		<td align="center" valign="middle" bgcolor="#application.color.display.med#"><b>#total#</i></td>
				</cfif>
			</cfif>
		</cfloop>
	</tr>
