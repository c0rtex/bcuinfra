...
<cfif saving eq 1>
	...
	<cfif errors eq 0>
		...
		<cflocation url="xlategroup.cfm?displaygroup_id=#displaygroup_id#&language_id=#language_id#">
		<cfabort>
	</cfif>
...
<h3>Site Text Translation</h3>
<h4>Site Text Group: <cf_checkAccessLink level="5" href="xlategroup.cfm?displaygroup_id=#displaygroup_id#&language_id=#language_id#">#dgname#</cf_checkAccessLink><br>Language: #lname#<br>String Name: "#translate.display_name#"</h4>
...
<table cellpadding="3" cellspacing="3" border="0">
	<form action="xlate.cfm?displaygroup_id=#displaygroup_id#&display_id=#display_id#&language_id=#language_id#" method="post">
	...
	<tr bgcolor="#application.color.display.med#">
		...
		<td align="left" valign="top" bgcolor="#application.color.display.light#"><textarea name="garbage" rows="6" cols="66" wrap="virtual">#HTMLEditFormat(translate.display_text)#</textarea></td>
	</tr>
	<tr bgcolor="#application.color.display.med#">
		<td align="left" valign="top"><b>#lname# Translation</b></td>
		<td align="left" valign="top" bgcolor="#application.color.display.light#"><textarea name="translation" rows="6" cols="66" wrap="virtual">#HTMLEditFormat(xlatestring)#</textarea></td>
		<cfif xlateError neq ''>
		<td align="left" valign="top" bgcolor="#application.color.display.dark#"><span style="color: #application.color.display.light#;"><i>#xlateError#</i></span></td>
		</cfif>
	</tr>
	<tr bgcolor="#application.color.display.med#">
		<td align="left" valign="top"><b>Incomplete?</b></td>
		<td align="left" valign="top" bgcolor="#application.color.display.light#"><input type="checkbox" name="incomplete" value="1"<cfif incomplete> checked</cfif>>&nbsp;&nbsp;<font size="-1"><i>Please check this box if you want to save your translation while it's not yet finished.</i></font></td>
	</tr>
	<tr bgcolor="#application.color.display.med#">
		<td align="left" valign="top">&nbsp;</td>
		<td align="left" valign="top" bgcolor="#application.color.display.light#"><input type="submit" value="Save Translation"> &nbsp; <input type="reset" value="Reset"> &nbsp; <input type="hidden" name="saving" value="1"></td>
	</tr>
	</form>
</table>
