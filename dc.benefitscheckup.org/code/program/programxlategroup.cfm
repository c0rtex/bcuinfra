...
<h3>Program Text Needing Translation</h3>
<h4>Program Text Group: #dgname#<br>Language: #lname#</h4>
...
<table cellpadding="3" cellspacing="3" border="0">
	...
	<tr bgcolor="#application.color.program.med#">
		...
		<td align="left" valign="top"<cfif update_flag eq 1 or update_flag eq ''> bgcolor="#application.color.program.light#"</cfif>>#xlate#</td>
		<cfif update_flag eq 1 or update_flag eq ''>
		<td align="left" valign="top" bgcolor="#application.color.program.light#">Yes</td>
		<cfelse>
		<td align="left" valign="top">No</td>
		</cfif>
		<td align="left" valign="top"<cfif update_flag eq 1 or update_flag eq ''> bgcolor="#application.color.program.light#"</cfif>><cf_checkAccessLink level="4" href="programxlate.cfm?displaygroup_id=#displaygroup_id#&display_id=#display_id#&language_id=#language_id#">edit</cf_checkAccessLink></td>
	</tr>
	</cfloop>
</table>
