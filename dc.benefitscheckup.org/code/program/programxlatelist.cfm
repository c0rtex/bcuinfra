...
<cfquery name="getgroup" datasource="#application.dbSrc#">
    ...
    where dg.displaygroup_id = '22' or dg.displaygroup_id = '21' or dg.displaygroup_id = '41' or dg.displaygroup_id = '40' or dg.displaygroup_id = '20' 
...
<cf_buildPage title="Program Text Administration" section="program"><cfoutput>

<h3>Number of Program Text Strings Requiring Translation</h3>

<table cellpadding="3" cellspacing="3" border="0">
	<tr>
		<td rowspan="2" align="left" valign="bottom" bgcolor="#application.color.program.dark#"><b>Program Text Category</b></td>
		<cfif colDef>
			<td colspan="#colDef#" align="center" valign="bottom" bgcolor="#application.color.program.dark#"><font size="-1"><i>default language</i></font></td>
		</cfif>
		<cfif colAct>
			<td colspan="#colAct#" align="center" valign="bottom" bgcolor="#application.color.program.med#"><font size="-1"><i>active languages</i></font></td>
		</cfif>
		<cfif colAct>
			<td colspan="#colIna#" align="center" valign="bottom" bgcolor="#application.color.program.light#"><font size="-1"><i>inactive languages</i></font></td>
		</cfif>
	</tr>
	<tr bgcolor="#application.color.program.med#">
	<cfloop query="getlang">
		<td align="center" valign="bottom"<cfif default_flag> bgcolor="#application.color.program.dark#"</cfif>><b>#language_id#</b><br><font size="-1"><i>#display_text#</i></font></td>
	</cfloop>
	</tr>
	<cfloop query="getgroup">
		<cfset dc = displaygroup_code>
	...
	<tr bgcolor="#application.color.program.light#">
		<td align="left" valign="bottom" bgcolor="#application.color.program.med#"><b>#displaygroup_name#</b></td>
		<cfset basic = 0>
		<cfloop query="getlang">
			<cfif default_flag>
				<cfset basic = Evaluate("grid.#dc#.#language_id#")>
				<cfset total = basic>
		<td align="center" valign="middle" bgcolor="#application.color.program.med#"><b>#basic#</b></td>
			<cfelse>
				<cfset total = basic - Evaluate("grid.#dc#.#language_id#")>
				<cfif total>
		<td align="center" valign="middle"><i><cf_checkAccessLink level="5" href="programxlategroup.cfm?displaygroup_id=#dd#&language_id=#language_id#">#total#</cf_checkAccessLink></i></td>
				<cfelse>
		<td align="center" valign="middle" bgcolor="#application.color.program.med#"><b><cf_checkAccessLink level="5" href="programxlategroup.cfm?displaygroup_id=#dd#&language_id=#language_id#">#total#</cf_checkAccessLink></b></td>
				</cfif>
			</cfif>
		</cfloop>
	</tr>
