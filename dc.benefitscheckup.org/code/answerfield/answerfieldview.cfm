...
<cfif action eq 'view' or hasSaved>
    ...
    <cf_buildList name="questionAssociate" table="question" code="question" title="Associated Questions" key="#id#" crosstable="question_answerfield" crosscolumn="answerfield_id" crossvalue="#id#" crossorder="sort" crossreorderlink="answerfieldquestionorder.cfm?id=#id#&name=questionAssociate" linkname="#linkname#" linksection="question" linktable="#linktable#" linkcolumn="#linkcolumn#" linkkeycolumn="#linkkeycolumn#" linkid="#linkid#" linkaction="#linkaction#">
