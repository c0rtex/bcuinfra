...
<cfloop list="#menuList#" index="x">
	...
	<cfif Evaluate("menuStruct.#x#.align") eq 'left'>
		...
		<td colspan="#total#">
		<cf_buildMenu_dev section="#x#" internal="true">
		</td></tr>
