	...
	<cfif validInput>
		...
		<cfelse>
			...
			<cfif NOT IsDefined('sr')>
				...
				<cfif attributes.title eq true>
				<cfif SESSION.partner_id EQ 0 AND SESSION.subset_id NEQ 39 AND SESSION.subset_id NEQ 27>
					<cfset outstr = outstr & '<div id="fact_sheet"><h1>Fact Sheet</h1>'>
				<cfelseif SESSION.partner_id EQ 0 AND SESSION.subset_id NEQ 39 AND SESSION.subset_id EQ 27>
					<cfset outstr = outstr & '<div id="fact_sheet"><h1>Fact Sheet</h1>'>
				<cfelseif SESSION.partner_id EQ 0 AND SESSION.subset_id EQ 39>
					<cfset outstr = outstr & '<div id="fact_sheet"><h1>Fact Sheet</h1>'>
				<cfelseif SESSION.partner_id EQ 77 and attributes.source eq 'taxrelief'>
					<cfset outstr = outstr & '<div id="fact_sheet">'>
				<cfelse>
					<cfset outstr = outstr & '<div id="fact_sheet"><h1>Fact Sheet</h1>'>
				</cfif>
				</cfif>
...
<cfif validInput>
	...
	<cf_displayText group="prgcat" code="prgcat_#pobj.cat#" var="categoryName">
	<cfif attributes.mode eq 'print' and attributes.title eq true>
			...
			<cfoutput>
				...
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<cfif snapProgram.RecordCount GT 0>
						<tr>
							<td class="text1fact" valign="top" width="24">
									<a href="http://www.snapretailerlocator.com" 
										target="http://www.snapretailerlocator.com" class="snapLink">
										<cf_displayImage code="img_house_snap_gif" hspace="0" vspace="0">
									</a>
							</td>
							<td class="text1fact" valign="top">
								<a href="http://www.snapretailerlocator.com" 
									target="http://www.snapretailerlocator.com">
...
<!---
<hr>
<p class="text1">For Michael's debugging in displayProgramDetail.cfm:</p>
