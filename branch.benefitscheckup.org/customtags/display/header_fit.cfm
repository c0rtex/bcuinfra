...
<div class="print">
	...
	<div style="clear:left; height:0px; line-height: 0px;"></div>
		...
		<div class="topheader">
			...
			<div class="bculogo" style="padding-top:10px; padding-left:50px;">
						<cfif Left(logo, 1) EQ "/">
			            	<cfset logo = ReReplaceNoCase(logo,"/","","ONE")>
			            </cfif>
						<cfset logo = logo>
				<cfif attributes.showmenu IS 1 AND val(session.org_id) IS 0>
					<cfif attributes.popupwarning IS 0>
						...
						<cfelse>
							<a href="#link#" target="_blank"><img src="/wp-content/uploads/2011/11/ncoa_footer_trans" alt="#alt#" title="#alt#"></a>
						</cfif>
					<cfelse>
				...
				<cfelse>
					<img src="/wp-content/uploads/2011/11/ncoa_footer_trans" alt="#alt#" title="#alt#">
				</cfif>
			</div>
			...
			<div class="logo" style="margin-top: #val(partnerQuery.wrapper_logo_margin_top)#; margin-right: #val(partnerQuery.wrapper_logo_margin_right)#;">
                ...
                <a href="#partnerQuery.wrapper_link#" target="#partnerQuery.wrapper_id#"><img src="#partnerQuery.wrapper_logo#" border="0" alt="#partnerQuery.wrapper_logo_alt_text#" title="#partnerQuery.wrapper_logo_alt_text#"></a>
                <cfelse>
                <img src="#partnerQuery.wrapper_logo#" border="0" alt="#partnerQuery.wrapper_logo_alt_text#" title="#partnerQuery.wrapper_logo_alt_text#">
                </cfif>
			</div>
			</cfif>
