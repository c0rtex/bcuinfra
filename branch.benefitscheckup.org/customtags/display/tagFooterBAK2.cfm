...
function openComment() {
    url = 
"http://beta.benefitscheckup.org/cso/contact/form.jsp?src=#session.feedbacksrc#";
...
<!--- choose footer  --->
<cfif wrapper.wrapper_footer IS NOT 'footer_normal.cfm' AND 
wrapper.wrapper_footer IS NOT ''>
		...
		<cfswitch expression="#attributes.partner_id#">
			...
			<cfcase value="12">
				<cfif  session.source_id GT 1>
					<cfinclude 
template="footer_aoa.cfm">
				<cfelse>
					<cfinclude 
template="footer_normal.cfm">
				</cfif>
			</cfcase>
			<cfcase value="13">
...
"https://64.236.110.194/stats/" : "https://64.236.110.194/stats/");
...
src="https://64.236.110.194/stats/piwik.php?idsite=1" style="border:0" 
alt=""/></p></noscript>
--->
<!-- End Piwik Tag --> 
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-3271369-18");
pageTracker._setDomainName(".benefitscheckup.org");
pageTracker._trackPageview();
} catch(err) {}</script>
