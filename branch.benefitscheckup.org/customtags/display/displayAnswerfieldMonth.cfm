...
</cfsilent><cfif attributes.mode neq 'print'><cfoutput><select name="#attributes.code#"><option value="">--month--</option><cfloop from="1" to="12" index="m"><option value="#m#"<cfif matchVal eq m> selected</cfif>><cf_displayText group="calendar" code="calendar_month_#m#"></option></cfloop></select></cfoutput><cfelse>________</cfif><cfsilent>
