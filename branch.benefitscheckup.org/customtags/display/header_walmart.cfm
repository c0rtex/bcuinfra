	...
	<div style="clear:left; height:0px; line-height: 0px;"></div>
		...
		<div class="topheader">
				...
				<cfif attributes.showmenu IS 1 AND val(session.org_id) IS 0>
					<cfif attributes.popupwarning IS 0>
						<cfif link IS "index.cfm">
							<cf_sessionPassVars href="index.cfm?partner_id=89"><img src="images/bcu.png" alt="BenefitsCheckUp" title="BenefitsCheckUp"></cf_sessionPassVars>
						<cfelse>
							<a href="index.cfm?partner_id=89"><img src="images/bcu.png" alt="BenefitsCheckUp" title="BenefitsCheckUp"></a>
						</cfif>
					<cfelse>
						<cf_displayText group="site" code="site_results_click_warning" var="clickText">
						<cfif link IS "index.cfm">
							<cf_sessionPassVars href="index.cfm?partner_id=89" prev_id="0" extralist="gohome=true" confirm="#clickText#"><cf_displayimage code="img_bculogo_gif"></cf_sessionPassVars>
						<cfelse>
							<cf_sessionPassVars href="index.cfm?partner_id=89" confirm="#clickText#"><img src="images/bcu.png" alt="BenefitsCheckUp" title="BenefitsCheckUp"></cf_sessionPassVars>
						</cfif>
					</cfif>
				<cfelse>
					<img src="images/bcu.png" alt="#alt#">
				</cfif>
			</div>
			...
			<div class="logo" style="display:none;margin-top: #val(partnerQuery.wrapper_logo_margin_top)#; margin-right: #val(partnerQuery.wrapper_logo_margin_right)#;">
				<cfif trim(partnerQuery.wrapper_link) IS NOT ""><a href="#partnerQuery.wrapper_link#"><img src="#partnerQuery.wrapper_logo#" border="0" alt="BenefitsCheckUp"></a><cfelse><img src="#partnerQuery.wrapper_logo#" border="0" alt="BenefitsCheckUp" title="BenefitsCheckUp"></cfif>
			</div>
			</cfif>
