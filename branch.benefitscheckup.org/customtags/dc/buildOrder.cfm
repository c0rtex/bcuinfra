...
<cfif attributes.saving eq 1>
	...
	<cfloop index="x" list="#orderlist#">
		<cfquery name="ordered" datasource="#application.dbSrc#">
			...
			where #keys#=#x#
			<cfelse>
			where #attributes.condition# and #attributes.crosskey#=#x#
			</cfif>
		</cfquery>
...
<cfquery name="ordered" datasource="#application.dbSrc#">
	...
	<cfif attributes.condition neq '' or attributes.crosscondition neq ''>where <cfif attributes.condition neq ''>#attributes.condition#</cfif><cfif attributes.condition neq '' and attributes.crosscondition neq ''> and </cfif><cfif attributes.crosscondition neq ''>#attributes.crosscondition#</cfif>
	</cfif>order by x.#attributes.ordercolumn#
</cfquery>
