...
<cfparam name="form.MQC_EMPLOYER_INSURANCE"  default="">
<cfif form.mqc_employer_insurance eq 'n'>
<cfparam name="form.mqc_retiree_plan" default="">
<cfparam name="form.mqc_employer_choose" default="">
<cfparam name="form.mqc_employer_money" default="">
<cfparam name="form.mqc_i_choose" default="">
</cfif>
<cfparam name="form.mqc_medicare_drug_plan" default="">
<cfparam name="form.mqc_medigap" default="">
<cfparam name="form.mqc_work_situation" default="">
<cfparam name="form.mqc_medicarecoverage" default="">
<cfparam name="form.mqc_outofpocket" default="">
<cfparam name="form.mqc_describesituation" default="">
<cfparam name="form.mqc_coveragesatisfaction" default="">
<cfparam name="form.mqc_plan_network_problem" default="">
<cfparam name="form.mqc_retiree_plan_select" default="">
<cfparam name="form.mqc_covers_healthcare_and_drugs" default="">
<cfparam name="form.mqc_covers_two_medicare_plans" default="">
<cfparam name="form.mqc_covers_healthcare_no_drugs" default="">
<cfif form.mqc_plan_network_problem eq 'mqc_plannetwork_bigproblem'>
	<cfparam name="form.mqc_plannetwork_bigproblem" default="y">
</cfif>
<cfif form.mqc_plan_network_problem eq 'mqc_plannetwork_minorproblem'>
	<cfparam name="form.mqc_large_employer" default="y">
</cfif>
<cfif form.mqc_plan_network_problem eq 'mqc_plannetwork_notproblem'>
	<cfparam name="form.mqc_plannetwork_notproblem" default="y">
</cfif>

<cfif form.mqc_retiree_plan_select eq 'mqc_employer_money'>
	<cfparam name="form.mqc_employer_money" default="y">
</cfif>
<cfif form.mqc_retiree_plan_select eq 'mqc_i_choose'>
	<cfparam name="form.mqc_i_choose" default="y">
</cfif>
<cfif form.mqc_retiree_plan_select eq 'mqc_employer_choose'>
	<cfparam name="form.mqc_employer_choose" default="y">
</cfif>

<cfif form.mqc_work_situation eq 'mqc_cobra'>
	<cfparam name="form.mqc_cobra" default="y">
</cfif>
<cfif form.mqc_work_situation eq 'mqc_large_employer'>
	<cfparam name="form.mqc_large_employer" default="y">
</cfif>
<cfif form.mqc_work_situation eq 'mqc_small_employer'>
	<cfparam name="form.mqc_small_employer" default="y">
</cfif>

<cfif form.mqc_medicarecoverage eq 'mqc_originalmedicare'>
	<cfparam name="form.mqc_originalmedicare" default="y">
</cfif>
<cfif form.mqc_medicarecoverage eq 'mqc_medhealthplan'>
	<cfparam name="form.mqc_medhealthplan" default="y">
</cfif>
<cfif form.mqc_medicarecoverage eq 'mqc_justenrolled'>
	<cfparam name="form.mqc_justenrolled" default="y">
</cfif>
<cfif form.mqc_medicarecoverage eq 'mqc_dontknowcoverage'>
	<cfparam name="form.mqc_dontknowcoverage" default="y">
</cfif>


<cfif form.mqc_outofpocket eq 'mqc_costsbigproblem'>
	<cfparam name="form.mqc_costsbigproblem" default="y">
</cfif>
<cfif form.mqc_outofpocket eq 'mqc_costsmodproblem'>
	<cfparam name="form.mqc_costsmodproblem" default="y">
</cfif>
<cfif form.mqc_outofpocket eq 'mqc_costsminorproblem'>
	<cfparam name="form.mqc_costsminorproblem" default="y">
</cfif>
<cfif form.mqc_outofpocket eq 'mqc_costsnotproblem'>
	<cfparam name="form.mqc_costsnotproblem" default="y">
</cfif>

<cfif form.mqc_describesituation eq 'mqc_situationchallenge'>
	<cfparam name="form.mqc_situationchallenge" default="y">
</cfif>
<cfif form.mqc_describesituation eq 'mqc_situationconfident'>
	<cfparam name="form.mqc_situationconfident" default="y">
</cfif>
<cfif form.mqc_describesituation eq 'mqc_situationmedicare'>
	<cfparam name="form.mqc_situationmedicare" default="y">
</cfif>	
<cfif form.mqc_describesituation eq 'mqc_situationhappy'>
	<cfparam name="form.mqc_situationhappy" default="y">
</cfif>
<cfif form.mqc_describesituation eq 'mqc_situationoverwhelmed'>
	<cfparam name="form.mqc_situationoverwhelmed" default="y">
</cfif>
<cfif form.mqc_describesituation eq 'mqc_situationplanner'>
	<cfparam name="form.mqc_situationplanner" default="y">
</cfif>
<cfif form.mqc_describesituation eq 'mqc_situation_noneofabove'>
	<cfparam name="form.mqc_situation_noneofabove" default="y">
</cfif>	

<cfif form.mqc_coveragesatisfaction eq 'verysatisfied'>
	<cfparam name="form.verysatisfied" default="y">
</cfif>
<cfif form.mqc_coveragesatisfaction eq 'satisfied'>
	<cfparam name="form.satisfied" default="y">
</cfif>
<cfif form.mqc_coveragesatisfaction eq 'somewhatdissatisfied'>
	<cfparam name="form.somewhatdissatisfied" default="y">
</cfif>
<cfif form.mqc_coveragesatisfaction eq 'verydissatisfied'>
	<cfparam name="form.verydissatisfied" default="y">
</cfif>
<!-- mqc_income -->
<cfif not isdefined('form.mqc_income')>
      <cfset form.mqc_income = 'mqc_income_under'>
      <cfparam name="form.mqc_income_under" default="y">
</cfif>
<cfif form.mqc_income eq 'mqc_income_over'>
	<cfparam name="form.mqc_income_over" default="y">
</cfif>
<cfif form.mqc_income eq 'mqc_income_range1'>
	<cfparam name="form.mqc_income_range1" default="y">
</cfif>
<cfif form.mqc_income eq 'mqc_income_range2'>
	<cfparam name="form.mqc_income_range2" default="y">
</cfif>
<cfif form.mqc_income eq 'mqc_income_range3'>
	<cfparam name="form.mqc_income_range3" default="y">
</cfif>
<cfif form.mqc_income eq 'mqc_income_under'>
	<cfparam name="form.mqc_income_under" default="y">
</cfif>

<cfif not isdefined('form.mqc_income_retired')>
      <cfset form.mqc_income_retired = 'mqc_income_under'>
      <cfparam name="form.mqc_income_retire_under" default="y">
</cfif>
<cfif form.mqc_income_retired eq 'mqc_income_retire_over'>
	<cfparam name="form.mqc_income_retire_over" default="y">
</cfif>
<cfif form.mqc_income_retired eq 'mqc_income_retire_range1'>
	<cfparam name="form.mqc_income_retire_range1" default="y">
</cfif>
<cfif form.mqc_income_retired eq 'mqc_income_retire_range2'>
	<cfparam name="form.mqc_income_retire_range2" default="y">
</cfif>
<cfif form.mqc_income_retired eq 'mqc_income_retire_range3'>
	<cfparam name="form.mqc_income_retire_range3" default="y">
</cfif>
<cfif form.mqc_income_retired eq 'mqc_income_retire_under'>
	<cfparam name="form.mqc_income_retire_under" default="y">
</cfif>

<!-- mqc_asset -->
<cfif not isdefined('form.MQC_INCASSET')>
	<cfparam name="form.MQC_INCASSET" default="">
	<cfparam name="form.mqc_asset_under" default="y">
</cfif>
<cfif form.mqc_incasset eq 'mqc_asset_over'>
	<cfparam name="form.mqc_asset_over" default="y">
</cfif>
<cfif form.mqc_incasset eq 'mqc_asset_range1'>
	<cfparam name="form.mqc_asset_range1" default="y">
</cfif>
<cfif form.mqc_incasset eq 'mqc_asset_range2'>
	<cfparam name="form.mqc_asset_range2" default="y">
</cfif>
<cfif form.mqc_incasset eq 'mqc_asset_range3'>
	<cfparam name="form.mqc_asset_range3" default="y">
</cfif>
<cfif form.mqc_incasset eq 'mqc_asset_under'>
	<cfparam name="form.mqc_asset_under" default="y">
</cfif>


<cfif attributes.debug><cfset flush = application.answerfieldPool.init()><cfoutput><br><br>Field List For Processing: #lsiList#</cfoutput><br><br></cfif>
<cfif attributes.debug><cfoutput><br>Process Fields:</cfoutput><br><br></cfif>
<cfset badList = ''>
<cfloop list="#lsiList#" index="itemID"> 
	...
	<cfif attributes.debug><cfdump var="#ansObj#"></cfif>
	...
	<cfelseif IsDefined("caller.#attributes.structname#.#lsiVar#") or lsiType eq 'c'>
		...
		<cfif attributes.debug><cfoutput><br>LIS VAL2A: lsiType #lsiType# 'caller.#attributes.structname#.#lsiVar#' #lsiVal# #attributes.structname#.#lsiVar#<br></cfoutput></cfif>
...
<cfset session.lsiDeriveList = lsiDeriveList >
...
<cfif lsiDeriveIncome>
	...
	<cfloop index="element" list="pri_retire,dividends,ssi,ss_disable,ss_retire,rr_ben,vet_ben,unemploy,tanf,unemployment,child_support,cash_assist,other_nw,earned,scsep,total_unearned,total_complete">
		<cfset rowaccumvar = 0>
...
<cfif ListFind(lsiDeriveList, 'skipinc')>
	...
	<cfif lsiSkipIncome eq 0>
		...
		<cfloop index="element" list="pri_retire,dividends,ssi,ss_disable,ss_retire,rr_ben,vet_ben,unemploy,tanf,unemployment,child_support,cash_assist,other_nw,earned,scsep">
			<cfloop index="class" list="s,sp,s_sp,hh">
...
<!--- Derive BE_CLNT_MAIL_ADDR_ST from CT_LIVE --->
<cfif ListFind(lsiDeriveList, 'ct_live')>
	<cf_handleScreeningAnswerfield action="get" code="ct_live" element="val" var="lsiLive">
	<cf_handleScreeningAnswerfield action="set" code="be_clnt_mail_addr_st" val="#lsiLive#">
	<cfset session.be_clnt_mail_addr_st = lsiLive>
</cfif>
...
<cfif attributes.debug><cfoutput><h3>Done with Log Screening Input</h3></cfoutput></cfif>
