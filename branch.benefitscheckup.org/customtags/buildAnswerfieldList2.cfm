...
<cfif attributes.debug neq ''>
	...
	<cfoutput>
	<b>question:</b>&nbsp; #getAF.question_id#: <a href="http://data.benefitscheckup.org/question/questionview.cfm?id=#getAF.question_id#&action=edit" target="dc">#attributes.debug#</a><br>
...
<cfoutput>
	<cfif attributes.code neq "fit_header1">
		<div<cfif attributes.errorcode neq '' or attributes.errortext neq ''> style="background: pink;"><p style="font-weight: bold; font-size: 14px;"><cfif attributes.errortext neq ''>#attributes.errortext#<cfelse><cf_displayText code="#attributes.errorgroup#_#attributes.errorcode#" group="#attributes.errorgroup#"></cfif></p><cfelse>></cfif>
	</cfif>
			...
			<cfcase value="multi_horizontal">
				<table border="0" cellspacing="2">
                    ...
                    <cf_loopPoolStruct struct="qobj" index="answerfield">
						...
						<tr style="font-size: 14px;"><td><cf_displayText code="answerfield_#answerfield#" group="answerfield"></td></tr></table></td>
						<cfset templist = ListAppend(templist, safitem)>
					</cf_loopPoolStruct>
					</tr>
				</table>
			...
			<cfcase value="multi_vertical">
				<table border="0" cellspacing="2">
					<cf_loopPoolStruct struct="qobj" index="answerfield">
						<cfset afobj = application.AnswerfieldPool.getAnswerfield("#answerfield#")>
						<tr style="font-family:  arial, helvetica, sans-serif; font-size: 14px; color: black;">
							<td align="right" style="font-size: 14px;"><cf_displayText code="answerfield_#answerfield#" group="answerfield"></td>
			...
			<cfcase value="radio_string_x3_specify_crncy_x1">
				<table border="0" cellspacing="2">
					...
					<cfloop from="0" to="#Evaluate(row - 1)#" step="2" index="x">
						...
						<tr style="font-family: arial, helvetica, sans-serif; font-size: <cfif session.subset_id is 61>12px<cfelse>14px</cfif>; color: black;">
							<td>
					...
					<tr id="tr_#Evaluate("#afb#_answerfield")#" style="font-family: arial, helvetica, sans-serif; font-size: <cfif session.subset_id is 61>12px<cfelse>14px</cfif>; color: black;">
...
<cf_buildAnswerfield name="#Evaluate("#afa#_answerfield")#" type="#Evaluate("#afa#_code")#" maxlength="#Evaluate("#afa#_max_length")#" format="#attributes.format#" display="" onClick="this.blur();" onChangeYes="var objrow = document.getElementById('tr_#Evaluate("#afc#_answerfield")#'); if (this.checked) objrow.style.display = '';" onChangeNo="var objno = document.getElementById('radio_no_#Evaluate("#afb#_answerfield")#'); var objrow = document.getElementById('tr_#Evaluate("#afc#_answerfield")#'); if (this.checked && objno.checked) {this.form.#Evaluate("#afc#_answerfield")#.value = ''; objrow.style.display = 'none';}"></td>
					...
					<tr style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: black;display: none;">
						<td><cfif attributes.format neq 'text_hide' and attributes.format neq 'text_rep_cur_ih_hide_others' and attributes.format neq 'text_yn_hide'></cfif><cf_buildAnswerfield name="#Evaluate("#afb#_answerfield")#" type="hiddenfieldZero" maxlength="#Evaluate("#afb#_max_length")#" format="#attributes.format#" display="" onClick="this.blur();" onChangeYes="var objrow = document.getElementById('tr_#Evaluate("#afc#_answerfield")#'); if (this.checked) objrow.style.display = '';" onChangeNo="var objno = document.getElementById('radio_no_#Evaluate("#afa#_answerfield")#'); var objrow = document.getElementById('tr_#Evaluate("#afc#_answerfield")#'); if (this.checked && objno.checked) {this.form.#Evaluate("#afc#_answerfield")#.value = ''; objrow.style.display = 'none';}"></td>
						<cfset templist = ListAppend(templist, safitem)>
					</tr>
					<tr id="tr_#Evaluate("#afc#_answerfield")#" style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: black;">
					...
					<tr id="tr_#Evaluate("#afd#_answerfield")#" style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: black;">
					...
					<tr id="tr_#Evaluate("#afe#_answerfield")#" style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: black;">
					...
					<tr id="tr_#Evaluate("#aff#_answerfield")#" style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: black;">
			...
			<cfcase value="radio_string_x3_specify_crncy_x2">
				<table border="0" cellspacing="2">
					...
					<tr id="tr_#Evaluate("#afc#_answerfield")#" style="font-family: arial, helvetica, sans-serif; font-size: <cfif session.subset_id is 61>12px<cfelse>14px</cfif>; color: black;">
			...
			<cfcase value="select_other_specify">
				<table border="0" cellspacing="2">
					...
					<tr style="font-family: arial, helvetica, sans-serif; font-size: <cfif session.subset_id is 61>12px<cfelse>14px</cfif>; color: black;">
						...
						<cfset templist = ListAppend(templist, safitem)>
					<tr id="tr_#af1_answerfield#" style="font-family: arial, helvetica, sans-serif; font-size: <cfif session.subset_id is 61>12px<cfelse>14px</cfif>; color: black;<cfif row eq 2> display: none;</cfif>">
			...
			<cfcatch><cfdump var="#qobj#"></cfcatch></cftry></cfcase>
				...
				<table border="0" cellspacing="2">
                	<tr style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: black;">
						<td>
                            ...
                            <div style="padding:2px 0 2px 0;font-size:12px;font-family: arial, helvetica, sans-serif;">
                            	<span>
                            ...
                            <div id="xtr_#Evaluate("af0_answerfield")#" style="margin:2px 0 0 50px;padding:2px;font-family: arial, helvetica, sans-serif;">
                                <cf_loopPoolStruct struct="qobj" index="answerfield">
                                    <cfset afobj = application.AnswerfieldPool.getAnswerfield("#answerfield#")>
                                    <cfif afobj.type NEQ "ny" OR answerfield NEQ "fit_mortgage_use">
                                        <div style="padding:2px 0 2px 0;color:black;font-size:12px;font-family: arial, helvetica, sans-serif;">
                                            <cf_buildAnswerfield name="#answerfield#" type="#afobj.type#" maxlength="#afobj.length#" format="#attributes.format#" display=""><cf_displayText code="answerfield_#answerfield#" group="answerfield">
                                        </div>
                                    </cfif>
                                    <cfset templist = ListAppend(templist, safitem)>
				...
				<div class="nota_check_#qobj.sort[qobj.sort.size()]#">
                	<cfloop from="0" to="#Evaluate(row - 1)#" step="2" index="x">
                        ...
                        <cfif Evaluate("#afb#_answerfield") is "fit_none_of_the_above4" AND evaluate("#afa#_answerfield") is "fit_invisible_q14">
                        	...
                        	<cfset templist = ListAppend(templist, safitem)>
                            <div class="ynMultiCheckMain" id="xtra_#qobj.sort[qobj.sort.size()]#" style="padding:2px 0 2px 0;font-size:12px;font-family: arial, helvetica, sans-serif;">
                			...
                			<cfset templist = ListAppend(templist, safitem)>
                		<cfelse>
                			<div class="ynMultiCheckMain" id="t_#Evaluate("#afa#_answerfield")#" style="padding:2px 0 2px 0;font-size:12px;font-family: arial, helvetica, sans-serif;">
                			...
                			<div class="ynMultiCheck" id="xtr_#Evaluate("#afa#_answerfield")#" style="margin-left:4px;font-family: arial, helvetica, sans-serif;padding:2px 0 2px 20px;font-size:12px;display:none;">
			...
			<cfcase value="fit_mutiple_checkbox_other">
				...
				<cfif attributes.code eq "fit_reasons" OR attributes.code eq "fit_difficulty" OR attributes.code eq "fit_needs_help">
					...
					<div class="fit_answerfield nota_check_#qobj.sort[qobj.sort.size()]#" class="fit_answerfield">
							...
							<cfelse>
								<div style="padding:2px 0 2px 0;font-family: arial, helvetica, sans-serif;">
				...
				<cfelse>					
					...
					<div class="fit_answerfield nota_check_#qobj.sort[qobj.sort.size()]#" class="fit_answerfield">
						<cf_loopPoolStruct struct="qobj" index="answerfield">
							<cfset afobj = application.AnswerfieldPool.getAnswerfield("#answerfield#")>
							<div id="xtra_#answerfield#" style="padding:2px 0 2px 0;font-family: arial, helvetica, sans-serif;">
                    ...
                    <cfif afobj.type IS "select" AND answerfield NEQ "fit_married_partner">
                    	...
                    	<cf_loopPoolStruct struct="afobj" index="option">
                            ...
                            <cfif option IS "fit_married_partner">
                            	<div id="#tempId#" class="showme" style="display:none;font-family: arial, helvetica, sans-serif;padding-top:4px;">
                            ...
                            <cfif option IS "widowed" OR option IS "fit_div_sep" OR option IS "single">
                            	...
                            	<div id="#tempId#" class="showme" style="display:none;font-family: arial, helvetica, sans-serif;">
