...
function help2old(i)
	{var h = window.open(i,'Hint',"scrollbars=yes,resizable=yes,width=500,height=600,top=100,left=100,screenx=100");
	}
function help2(i)
	{var h = open(i, 'Help', 
...
function validatetext(field) {
	...
	if (ok == "no") {
	alert("Please remove any special characters (i.e. quotation marks or ampersands or spaces)");
	field.focus();
	field.select();
	   }
	}
...
function validate()
{
	...
	var other = document.formwelcome.other_client
...
function recapwin(i)
	{var d =window.open(i,'Glossary',"scrollbars=yes,resizable=yes,width=400,height=375,top=150,screenY=150,left=150,screenX=150");}
