...
<cfelse>
	...
	<cf_loopPoolStruct struct="pobj" sortBy="req" index="reqCode">
		...
		<cfelse>
			<cfset outstr = outstr & "<li><a href=""javascript:lookup('#application.transfertype#://#client.serverPath#/popText.cfm?titlegroup=requisite&titlecode=#reqObj.name#&group=reqdef&code=#reqObj.def#')"">#reqName#</a></li>">
