...
<cfelse>
<p>
How has this service been helpful to you? How can we make it better? Please take a moment to send your comments and suggestions to <cfoutput><a href="mailto:#request.comments_address#">#request.comments_address#</a></cfoutput>.
</p>
</cfif>
