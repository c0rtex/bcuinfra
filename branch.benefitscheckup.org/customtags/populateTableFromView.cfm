...
<cfif application.subsetsUseViews>
	...
	<cfelseif attributes.table eq 'xsubset'>
		...
		<cfif attributes.full or countQuery.rowct eq 0>
			<cfquery name="populateTable" datasource="#application.dbSrc#">
				...
				FROM view_xsubset where subset_name <> ''
			</cfquery>
			<cftry><cfquery name="populateTable" datasource="#application.dbSrc#">
			INSERT INTO `xsubset` VALUES ('68', '1', 'Help for the Unemployed', 'Help for the Unemployed', '', 'AARP subset for people who are unemployed', '', '', null, '0', '0', '1', '0', '0', '1', '1', '1', '1');
			</cfquery><cfcatch></cfcatch></cftry>
		</cfif>
	<cfelseif attributes.table eq 'xsubset_xincometypeDisabled'>
		<cfif attributes.full>
			<cfquery name="clearQuery" datasource="#application.dbSrc#">
	...
	<cfelseif attributes.table eq 'xsubset_xincass' and (1 eq 0)>
	<!--- SE Disabled--->
		<cfif attributes.full>
			<cfquery name="clearQuery" datasource="#application.dbSrc#">
	...
	<cfelseif attributes.table eq 'tbl_questions_new'>
		...
		<cfif attributes.full or countQuery.rowct eq 0>
			<cfquery name="populateTable" datasource="#application.dbSrc#">
				...
				FROM view_tbl_questions_new where question_id <> 139
			</cfquery>
		</cfif>
