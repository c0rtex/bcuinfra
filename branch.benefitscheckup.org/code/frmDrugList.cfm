				...
				<form action="procDrugQuestions.cfm" method="post" name="formDrug" id="formDrug">
					...
					<div class="question">
						<div class="questionHolder questionBar">
							...
							<p>Many pharmaceutical companies have Patient Assistance Programs that will
provide some of their medications at no cost or at a discounted rate. The list
below contains certain brand name and generic drugs that are offered through a
program. If you do not see your medication in the list, please click on the
"Medication not in list" button to find out what you should do.</p>
								For each medication you take, search through the list below, click the name of
the medication, and click the button &quot;I take this.&quot; When all your medications
appear in the list to the right, you should scroll to the very bottom of the
page and click &quot;Next&quot;.<em> (If you would like to choose your medications one at a
time from alphabetical lists, click <a id="popupLink240" href="#">click here</a>.)</em>
							</p>	
						</div><!-- questionHolder -->
					</div><!-- question -->	
...
<cfelse>
	...
	<FONT face="Arial" size="3">Many pharmaceutical companies have Patient Assistance Programs that will
provide some of their medications at no cost or at a discounted rate. The list
below contains certain brand name and generic drugs that are offered through a
program. If you do not see your medication in the list, please click on the
"Medication not in list" button to find out what you should do.
<p>For each medication you take, search through the list below, click the name of
the medication, and click the button &quot;I take this.&quot; When all your medications
appear in the list to the right, you should scroll to the very bottom of the
page and click &quot;Next&quot;.<em>(If you would like to choose your medications one at a time from alphabetical lists, <a id="popupLink240" href="##">click here</a>.)</em>
	</p></font>
