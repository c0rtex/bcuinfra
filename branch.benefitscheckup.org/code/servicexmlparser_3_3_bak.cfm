...
<cfparam name="url.testresponse" default="0">
...
<cfparam name="request.debug" type="boolean"  default="true">
<cfset request.debug = "false">
<cfset application.chicagovars = structnew()>
<!-- default test parameter xml string -->
<cfif (testresponse or url.testresponse) and not isdefined('response_list')>
<cfset xmlstring = '
<?xml version="1.0" encoding="utf-16"?>
<ScreeningSet>
<Screening Subset_id="83">
<Answer AnswerField="esi_zip" AnswerValue="10022" ></Answer>
...
<cfif request.debug><cfdump var="#radio_mapping#"></cfif>
...
<cfif current_subset_id eq 79>
	...
	<cfif response_set.mqc_medicare_enroll_disability_yes eq 'y' or response_set.mqc_medicare_enroll_age_65 eq 'y'>
		<cfset request.next_subset_id = 72>
	...
	<cfelseif response_set.mqc_medicare_enroll_within_1_year_no  eq 'y' >
		<cfset request.next_subset_id = 0>
	<cfelse >
...
<cfelseif current_subset_id eq 75 or current_subset_id eq 72 or current_subset_id eq 74 >
<cfif current_subset_id eq 72 or current_subset_id eq 74>
...
<!--- UPDATE screening.end_datetime in database --->
	...
	<cfif request.subset_id eq 75 or request.subset_id eq 74 or request.subset_id eq 72 >
...
<cfif request.subset_id eq 75 or request.subset_id eq 74 or request.subset_id eq 72 or request.subset_id eq 80 or request.subset_id eq 83 >
<cfif request.debug> <cfdump var="#response_set#"></cfif>
<cfinvoke  
    component="util" 
