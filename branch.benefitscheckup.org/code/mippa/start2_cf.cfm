        ...
        <td width="520" valign="top">
			<div id="jQueryUITabs1">
			  	<ul>
                    ...
                    <li><a href="#jQueryUITabs1-4"><span>About Extra Help</span></a></li>
       	  	  	</ul>
                ...
                <div id="jQueryUITabs1-4"> 
                	<h3 align="center">About LIS Extra Help</h3>
					<p>
				...
				<div style="font-size:12px;padding:4px;border-left:1px solid #519e2d;border-right:1px solid #519e2d;border-bottom:1px solid #519e2d;">
                    ...
                    <img src="img/bculogo.gif" border="0" style="margin-top:4px;" />
                    Apply Now
                    </a>
                </div>
		  		</div>
       	  ...
       	  <div>
				...
				<div class="columnTitle" style="margin-top:4px;border-bottom:1px solid #519e2d">
       	  	    <p>Enter your City,  Zip Code</p>
                  	<form action="locator.cfm?zipSearch=1&template=2" method="post">
