...
<cfcomponent persistent="true" entityname="event_handler" table="event_handler" extends="ToStructConverter">
  ...
  <cfproperty name="event" fieldtype="many-to-one" missingRowIgnored="true" fkcolumn="event_id" cfc="event">
  <cfproperty name="answer_field" fieldtype="many-to-one" missingRowIgnored="true" fkcolumn="answerfield_id" cfc="answer_field">
