...
<cfcomponent persistent="true" entityname="subset" table="subset" extends="ToStructConverter">
    ...
    <cfproperty name="type" fieldtype="many-to-one" fkcolumn="subsettype_id" cfc="subset_type">
    <cfproperty name="code">
    <cfproperty name="description">
    <cfproperty name="display" fieldtype="many-to-one" fkcolumn="display_id" cfc="display">
    <cfproperty name="alt_display" fieldtype="many-to-one" fkcolumn="alt_display_id" cfc="display">
    <cfproperty name="spq_display" fieldtype="many-to-one" fkcolumn="spq_display_id" cfc="display">
    <cfproperty name="oe_name">
    <cfproperty name="intro_display" fieldtype="many-to-one" fkcolumn="intro_display_id" cfc="display">
    <cfproperty name="result_page" fieldtype="many-to-one" fkcolumn="resultpage_id" cfc="result_page">
    <cfproperty name="shadow_subset" fieldtype="many-to-one" fkcolumn="shadow_subset_id" cfc="subset">
    <cfproperty name="branding_partner" fieldtype="many-to-one" fkcolumn="branding_partner_id" cfc="partner">
