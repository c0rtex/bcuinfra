...
<cfcomponent persistent="true" entityname="user" table="user" extends="ToStructConverter">
	<cfproperty name="id" fieldtype="id" column="user_id">
	<cfproperty name="user_type" fieldtype="many-to-one" missingRowIgnored="true" fkcolumn="usertype_id" cfc="user_type">
	...
	<cfproperty name="address" fieldtype="many-to-one" missingRowIgnored="true" fkcolumn="address_id" cfc="address">
</cfcomponent>