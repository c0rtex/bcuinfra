...
<cfcomponent persistent="true" entityname="answer_field_option" table="answerfield_option" extends="ToStructConverter">
    <cfproperty name="answerfield_id" fieldtype="id">
    <cfproperty name="option" tostructcomponent="" fieldtype="id,many-to-one" fkcolumn="option_id" cfc="option">
