	...
	<table border="0" cellspacing="0" cellpadding="5">
		<tr>
			<td valign="top" align="center">
				<form>
				<input type="button" value="Print Forms" onClick="parent.lowerframe.print();"><br>
			...
			<td valign="top" align="right">
				<table border="0" bgcolor="white"><tr><td style="font-family: Arial, Helvetica, Verdana, sans-serif; font-size: 9pt;">
					Your selected forms appear below.  Click button to print.
				</td></tr></table>
			</td>
			<td valign="top" align="left">
					<input type="button" name="facthelp" value="Help" onClick="help2('hlpPrintMarkedFrame.cfm')">
			</td>
		</tr>
	</table>
