...
<li>Estimates of current expenses (such as mortgage/rent, utilities, out-of-pocket medical bills, expenses for caring for someone at home while the person works or goes to school, etc.)</li>
<LI>Current income and assets from all sources for self, spouse and others in the household </LI>
<li>Names of prescription medications (we recommend having the prescription bottles or information available about the person's medications from their health professional)</li> 
</ul>
<cf_tagClose></b></p>
</body>
</html>
