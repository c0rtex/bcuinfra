...
<cfset session.client_id=url.eversafe_id>
<cfelse>
...
insert into ecu_eversafe (screening_id, eversafe_id) values (#tmpScreeningID#, #url.eversafe_id#);
	...
	<cfif url.esiprod eq 1>
      <cfif url.eversafe_id neq 0>
	<cfoutput><meta http-equiv="refresh" content="0;url=https://www.economiccheckup.org/esi-results-eversafe/?screeningID=#tmpScreeningID#&shadowID=#session.screening_id#&eversafe_id=#url.eversafe_id#"></cfoutput>
<cfelse>
