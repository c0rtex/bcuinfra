...
<html>
<head>
<title>TIPS ON USE for <cf_tagBCU subset_id="#session.subset_id#"></title>
<body bgcolor="#FFFFFF" link="#00594B" alink="#00594B" vlink="purple" onLoad="window.focus();">
<font face="arial" size="3">
<h3>TIPS ON USE for <cf_tagBCU subset_id="#session.subset_id#"></h3>

<cf_tagClose><p>

<b><i>Having Information Readily Available</i></b> - We've found that having the necessary information at your fingertips makes completing the questions easier. Here's a quick <cf_tagBCU subset_id="#session.subset_id#"> List that you may want to refer to when gathering materials.<ul>
<li>ZIP code</li> 
<cfif session.subset_id eq 38>
<li>Date of birth</li> 
<li>Type of residence (house, apartment, or mobile home)</li> 
<li>Veteran status</li>
<li>Estimates of current expenses (such as mortgage/rent, utilities,
out-of-pocket medical bills, expenses for caring for someone at home while the
person works or goes to school, etc.)</li>
<li>Current income and assets from all sources for self, spouse and others in the household</li> 
<li>Names of prescription medications (we recommend having the prescription
bottles or information available about the person's medications from their
health professional)</li>
<cfelse>
<cfif session.subset_id neq 1>
<li>Type of residence (house, apartment, or mobile home)</li> 
...
<b><i>Try Again in Six Months</i></b> - <cf_tagBCU subset_id="#session.subset_id#"> is updated and improved regularly.  New programs are added, eligibility rules and criteria are updated regularly, and your life situation may change. Therefore, we recommend that you come back and complete another <cf_tagBCU subset_id="#session.subset_id#"> screening.  Doing so may identify programs for you that could significantly impact the quality of your life or the life of a loved one.
<BR><BR>

If your medical condition or the medications you are currently taking change, we recommend that you complete another <cf_tagBCU subset_id="#session.subset_id#"> screening.  Programs that provide prescription discounts are related to specific medications.  If your medications change, you may find that you are eligible for additional benefits programs.
<p>
