<!---
Template Name: extrahelp_cf.cfm 
Component Purpose: display content for the extra help info page
Data Tables: NA	
--->
...
<!---</p>--->
<p>Not sure if you should apply? Answer a few questions to find out. <a href="frmwelcome2.cfm?subset_id=27&amp;&sc_partner_id=<cfoutput>#SESSION.sc_partner_id#</cfoutput>">Get Started</a>
</p>
<p>
 <a href="/lisapp/start.cfm" onclick="this.href='dispatch.cfm?source_id=1&amp;prev_id=0&amp;org_id=0&amp;partner_id=<cfoutput>#URL.partner_id#</cfoutput>&amp;sc_partner_id=<cfoutput>#SESSION.sc_partner_id#</cfoutput>&amp;subset_id=41&amp;language_id=EN&amp;access_id=0&amp;client_id=NULL&amp;user_id=NULL&amp;test_id=0&amp;bcu_url=/lisapp/start%2Ecfm';" class="linkbutton">Apply Now</a> 
</p>
