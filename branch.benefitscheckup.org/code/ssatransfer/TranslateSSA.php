...
class TranslateSSA
{
		...
		foreach($answers as $key => $value)
		{
			...
			{	
				...
				case "BE_CNTCT_FNM":
					...
					break;
				case "BE_CNTCT_PHNAREA":
					if (!defined($_GET['batchFlag'])){
						$this->translateContact();
						break;	
					}
				case "CT_CNTCT_PHONE":
	...
	function translateContact()
	{
		...
		{
			$this->answers['BE_CNTCT_PHNAREA'] = "";
			$this->answers['BE_CNTCT_PHNEXCH'] = "";
			$this->answers['BE_CNTCT_PHNNUM'] = "";
		}
		if($this->answers['BE_CNTCT_PHNAREA'] == "")	
		{
