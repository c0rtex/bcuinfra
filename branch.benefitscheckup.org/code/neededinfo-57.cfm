...
<cfoutput>
<h3>Information You'll Need for <cfif trim(wrapper.wrapper_needed_title) IS NOT "">#wrapper.wrapper_needed_title#<cfelse><cf_tagBCU></cfif></h3>
</cfoutput>
...
<li><strong>Length of time in current residence</strong></li>
