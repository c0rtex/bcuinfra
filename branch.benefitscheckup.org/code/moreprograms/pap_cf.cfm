<cfoutput>
<cfif val(partnerQuery.wrapper_pap)>

<div class="icon"><cf_displayImage code="img_home_tool_off2_gif" height="22" width="19" hspace="0" vspace="0"></div>

<div class="apply2"><div class="h1"><cfif trim(partnerQuery.wrapper_pap_custom_name) IS NOT "">#partnerQuery.wrapper_pap_custom_name#<cfelse>Patient Assistance Programs</cfif>:</div>
...
<td valign="top" width="68%"><div class="box">
	<div class="box-outer">
		<div class="box-inner">
			...
			<p class="text10" style="margin-bottom:0px;"><cf_sessionPassVars href="frmwelcome2.cfm?partner_id=#SESSION.partner_id#" subset_id="19" class="linkbutton">Go!</cf_sessionPassVars></p>
			</div>
		</div>
	</div>	
</div></td>
...
<p class="text10" style="margin-bottom:0px;"><cf_sessionPassVars href="printed.cfm?partner_id=#SESSION.partner_id#" subset_id="19" class="linkbutton">Go!</cf_sessionPassVars></p>
			</div>
		</div>
	</div>	
</div></td>
