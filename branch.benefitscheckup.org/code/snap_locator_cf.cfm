<!---cfif IsDefined('SESSION.partner_id') AND SESSION.partner_id EQ 0>	
	<cfset SESSION.application_id = 2>
	<cfset StructDelete(SESSION, 'program_id')>
	...
	<cf_displayText group="site" code="site_snap_locator_main_title" var="site_snap_locator_main_title_country">
	<cf_displayText group="site" code="site_snap_locator_main_title" var="site_snap_locator_main_title_state">
	<cf_displayText group="site" code="site_snap_locator_office_title" var="site_snap_locator_office_title">
	<cf_displayText group="site" code="site_snap_locator_intro_language_country_map" var="site_snap_locator_intro_language_country_map">
	<cf_displayText group="site" code="site_snap_locator_intro_language_state_map" var="site_snap_locator_intro_language_state_page">
	<cf_displayText group="site" code="site_snap_locator_intro_language_office_page" var="site_snap_locator_intro_language_office_page">
	
	
		<!---<h1>#site_snap_locator_main_title_country#</h1>
			<p>#site_snap_locator_intro_language_country_map#</p>
	
	
		<h1>#site_snap_locator_main_title_state#</h1>
			<p>#site_snap_locator_intro_language_state_page#</p>--->
	
		<h1 align="center">#site_snap_locator_office_title#</h1>
			<p>#site_snap_locator_intro_language_office_page#</p>
			...
			<form action="snap_locator.cfm?zipSearch=1&partner_id=<cfoutput>#URL.partner_id#</cfoutput>" method="post">
				<div id="zip_code_search">
					...
					<div id="flash_map">
						<script type="text/javascript">
						AC_FL_RunContent( 'codebase','https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0','width','#mapWidth#','height','#mapHeight#','id','flashMap','align','middle','src','us_city_map/golden_usa_external?xmlfile1=us_city_map/snap_usa.xml&show_map=#showmap#','quality','high','wmode','transparent','bgcolor','##ffffff','name','golden_usa_external','allowscriptaccess','sameDomain','pluginspage','https://www.macromedia.com/go/getflashplayer','movie','us_city_map/golden_usa_external','flashvars','xmlfile1=us_city_map/snap_usa.xml&show_map=#showmap#' ); //end AC code
						</script>
						
						<noscript>
							<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0"  width="#mapWidth#" height="#mapHeight#" id="flashMap" align="middle">
								<param name="allowScriptAccess" value="sameDomain" />
								<param name="movie" value="us_city_map/golden_usa_external.swf" />
								<PARAM NAME=FlashVars VALUE="xmlfile1=us_city_map/snap_usa.xml&show_map=#showmap#">
								<param name="quality" value="high" />
								<param name="wmode" value="transparent" />
								<param name="bgcolor" value="##ffffff" />
								<embed src="us_city_map/golden_usa_external.swf?xmlfile1=us_city_map/snap_usa.xml&show_map=#showmap#&partner_id=#URL.partner_id#" quality="high" wmode="transparent" bgcolor="##ffffff" width="#mapWidth#" height="#mapHeight#" name="golden_usa_external" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/go/getflashplayer" />
							</object>
						</noscript>
					...
					<div id="officeCol" <cfif showOffices IS 1>style="display:none;"</cfif>>
						...
						<cfif showMap GT 0>
						    ...
						    <cfquery name="findState" datasource="#application.dbSrc#">
								SELECT *
								FROM zip
								WHERE zipcode = '#attributes.zip#'
							</cfquery>
							<cfset myState = "#Trim(findState.state_id)#">
						 
							<cfquery name="getPrgID" datasource="#application.dbSrc#">
								Select program_id as pid
						    	from program
						    	where state_id = '#myState#' and programcategory_id = 23
							</cfquery>
						
							<cfif getPrgID.RecordCount eq 1>
								<cfparam name="attributes.program_id" default="#getPrgID.pid#">
							</cfif>
						
							<cf_displayProgramDetailEntrypoints program_id="#attributes.program_id#" mode="screen" source="" zipcode="#attributes.zip#" limit="100" var="outstr" append="false" suppressText="True" suppressOfficesLink="True" google="true">
						...
						<cfelseif county_id IS NOT "">
							...
							<cfset myState = "#Trim(findCounty.state_id)#">
						 
							<cfquery name="getPrgID2" datasource="#application.dbSrc#">
								Select program_id as pid
						    	from program
						    	where state_id = '#myState#' and programcategory_id = 23
							</cfquery>
						
							<cfif getPrgID2.RecordCount eq 1>
								<cfparam name="attributes.program_id" default="#getPrgID2.pid#">
							</cfif>
						    
							<cfparam name="attributes.county_id" default="#county_id#">
						    	
							<cf_displayProgramDetailEntrypoints program_id="#attributes.program_id#" mode="screen" source="" county_id="#attributes.county_id#" limit="100" var="outstr" append="false" suppressText="True" suppressOfficesLink="True" proximityOverride="county" google="true">
...
<cfelse--->
	...
	<div class="introText" id="language_country_map" <cfif showmap GT 0>style="display:none;"</cfif>>
		...
		<h1 id="locatorTitle" class="locatorH1" style="text-align:center; width:100%; margin-top:0px; padding-top:0px;">#site_snap_locator_main_title_country#</h1>
		<p class="text1" <cfif showmap GT 0>style="margin-right:24px;" </cfif>>
		#site_snap_locator_intro_language_country_map#
		</p>
	</div>
	
	
	<div class="introText" id="language_state_map" style="display:none; width:100%">
		<h1 id="locatorTitle" class="locatorH1" style="text-align:center; width:100%; margin-top:0px; padding-top:0px;">#site_snap_locator_main_title_state#</h1>
		<p class="text1" <cfif showmap GT 0>style="margin-right:24px;" </cfif>>
	#site_snap_locator_intro_language_state_page#
		</p>
	</div>
	</p>
	...
	<div class="introText" id="language_office_map" <cfif showmap IS 0>style="display:none;"</cfif>>
		...
		<h1 id="locatorTitle" class="locatorH1" style="text-align:#alignHeader#; width:100%; margin-top:0px; padding-top:0px;">#site_snap_locator_office_title#</h1>
		<p class="text1" <cfif showmap GT 0>style="margin-right:24px;" </cfif>>
	#site_snap_locator_intro_language_office_page#
		</p>
	</div>
	</p>
	...
	<center>
    	...
    	<cfelse>
			<script type="text/javascript">
                    AC_FL_RunContent( 'codebase','https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0','width','#mapWidth#','height','#mapHeight#','id','flashMap','align','middle','src','us_city_map/golden_usa_external?xmlfile1=us_city_map/snap_usa_pl.xml&show_map=#showmap#','quality','high','wmode','transparent','bgcolor','##ffffff','name','golden_usa_external','allowscriptaccess','sameDomain','pluginspage','https://www.macromedia.com/go/getflashplayer','movie','us_city_map/golden_usa_external','flashvars','xmlfile1=us_city_map/snap_usa_pl.xml&show_map=#showmap#' ); //end AC code
                    </script>
                    ...
                    <noscript>
                        <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0"  width="#mapWidth#" height="#mapHeight#" id="flashMap" align="middle">
                            <param name="allowScriptAccess" value="sameDomain" />
                            <param name="movie" value="us_city_map/golden_usa_external.swf" />
                            <PARAM NAME=FlashVars VALUE="xmlfile1=us_city_map/snap_usa_pl.xml&show_map=#showmap#">
                            <param name="quality" value="high" />
                            <param name="wmode" value="transparent" />
                            <param name="bgcolor" value="##ffffff" />
                            <embed src="us_city_map/golden_usa_external.swf?xmlfile1=us_city_map/snap_usa_pl.xml&show_map=#showmap#&partner_id=#URL.partner_id#" quality="high" wmode="transparent" bgcolor="##ffffff" width="#mapWidth#" height="#mapHeight#" name="golden_usa_external" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/go/getflashplayer" />
                        </object>
                    </noscript>
    	</cfif>
	</center>
	...
	<h2 class="snapH2" style="margin:0px;">SNAP Office(s):</h2>			
