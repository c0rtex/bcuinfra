...
<div class="box">
	<div class="box-outer">
		<div class="box-inner">
			<div class="box-content"><cf_sessionPassVars href="/cf/snap.cfm?partner_id=89" partner_id="89" prev_id="0" target="snap" class="indexh2b"><cf_displayImage code="img_food_gif"  border="0" align="right" class="icon2" style="margin-bottom:0px;">Need Help Paying for Food?</cf_sessionPassVars></div>
...
<td valign="top" width="32%"><div class="box">
	<div class="box-outer" >
		<div class="box-inner">
			...
			<p class="text3">
			<cf_sessionPassVars href="/cf/snap.cfm?partner_id=#wrapper.partner_id#" prev_id="0" class="linkbutton">Learn More</cf_sessionPassVars>
			</p>
