<cfcomponent   >
  ...
  <cffunction access="remote" name="getProgramEntryPoints" output="false" returntype="string" hint="returns entry point offices by program"  >
	...
	<cfset testzipcode = "#zip#">
    	...
    	<cf_displayprogramdetail program_id = "#program_id#" state_id="#state_id#" county="#county#" zip="#testzipcode#" source="ec" supressforms="true" suppressOfficesLink="true" eplimit="#limit#" requisites="false" description="false"  entrypoints="true"  var="resultstring" report_type="webservice" >
   ...
   <cffunction access="remote" name="getProgramDetails" output="false" returntype="string"  hint="returns details and description about program" >
	...
	<cfset session.st = state_id >
   	...
   	<cfset session.org_id = 0>
    	<cfset resultstring = "">
	<cf_displayprogramdetail program_id = "#program_id#" state_id="#state_id#" county="#county#" zip="#zip#" source="ec" eplimit="#eplimit#" requisites="#showrequisites#" description="#showdescription#"  entrypoints="#showentrypoints#"  var="resultstring" supressforms="true" suppressOfficesLink="true" report_type="webservice"  >
   ...
   <cffunction access="remote" name="getProgramForms" output="false" returntype="string" hint="returns application forms by program"   >
	...
	<cfif format eq "html">
	<cf_displayprogramdetailforms foodStampLegendVar="a" multiProgramLegendVar="b" fillableLegendVar="c" program_id = "#program_id#" state_id="#state_id#"  var="resultstring" formtype_id=0 source="details" >
	<cfelse>
	<cf_displayprogramdetailforms foodStampLegendVar="a"  multiProgramLegendVar="b"  fillableLegendVar="c"  program_id = "#program_id#" state_id="#state_id#"  var="resultstring" formtype_id=0 source="details" format="xml">
	</cfif>
	<cfreturn  resultstring>
  </cffunction>
