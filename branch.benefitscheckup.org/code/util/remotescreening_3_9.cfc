<cfcomponent   >
    <cffunction access="remote" name="getProgByCat" output="false" returntype="query"  hint="Returns the version of the questionnaire subset based on subset_id"  >
        <!-- pass arguments -->
...
order by prq.sort
    ...
    <cffunction access="remote" name="getWPPost" output="false" returntype="query"  hint="Gets Post Content from the NCOA WP DB"  >
        <!-- pass arguments ...removed db prefix -->
