<cfcomponent   >
  ...
  <cffunction access="remote" name="getProgramEntryPoints" output="false" returntype="string" hint="returns entry point offices by program"  >
    ...
    <cf_displayprogramdetail program_id = "#program_id#" state_id="#state_id#" county="#county#" zip="#testzipcode#" source="ec" supressforms="true" suppressOfficesLink="true" eplimit="#limit#" requisites="false" description="false"  entrypoints="true"  var="resultstring"  >
   ...
   <cfset session.org_id = 0>
    <cfset resultstring = "">
	<cf_displayprogramdetail program_id = "#program_id#" state_id="#state_id#" county="#county#" zip="#zip#" source="ec" eplimit="#eplimit#" requisites="#showrequisites#" description="#showdescription#"  entrypoints="#showentrypoints#"  var="resultstring" supressforms="true"  >
