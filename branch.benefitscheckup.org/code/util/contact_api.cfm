...
<!--[if gt IE 8]><!--> <html lang="en-US" class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<!-- icons & favicons -->
		<link rel="apple-touch-icon" href="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/library/images/apple-icon-touch.png">
		<link rel="icon" href="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/favicon.png">
		<!--[if IE]>
			<link rel="shortcut icon" href="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/favicon.ico">
		<![endif]-->
		


  	<link rel="pingback" href="https://medicarequickcheck.benefitscheckup.org/xmlrpc.php">
  	...
  	<![endif]-->
		...
		<link rel="alternate" type="application/rss+xml" title="Medicare QuickCheck &raquo; Feed" href="https://medicarequickcheck.benefitscheckup.org/feed/" />
<link rel="alternate" type="application/rss+xml" title="Medicare QuickCheck &raquo; Comments Feed" href="https://medicarequickcheck.benefitscheckup.org/comments/feed/" />
<link rel="alternate" type="application/rss+xml" title="Medicare QuickCheck &raquo; Screening Contact Comments Feed" href="https://medicarequickcheck.benefitscheckup.org/screening-contact/feed/" />
<link rel='stylesheet' id='rbcu-stylesheet-css'  href='https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/responsive/css/bootstrap.min.css?ver=4.0.1' type='text/css' media='all' />
<link rel='stylesheet' id='rbcu-mqc-stylesheet-css'  href='https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/mqc.css?ver=4.0.1' type='text/css' media='all' />
<script type='text/javascript' src='https://medicarequickcheck.benefitscheckup.org/wp-includes/js/jquery/jquery.js?ver=1.11.1'></script>
<script type='text/javascript' src='https://medicarequickcheck.benefitscheckup.org/wp-includes/js/jquery/jquery-migrate.min.js?ver=1.2.1'></script>
<script type='text/javascript' src='https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/responsive/js/bootstrap.min.js?ver=4.0.1'></script>
<script type='text/javascript' src='https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/mqc.js?ver=4.0.1'></script>
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://medicarequickcheck.benefitscheckup.org/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="https://medicarequickcheck.benefitscheckup.org/wp-includes/wlwmanifest.xml" /> 
<meta name="generator" content="WordPress 4.0.1" />
<link rel='canonical' href='https://medicarequickcheck.benefitscheckup.org/screening-contact/' />
<link rel='shortlink' href='https://medicarequickcheck.benefitscheckup.org/?p=42' />
	<style type="text/css">.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style>
           ...
           <script type="text/javascript" src="/wp-content/themes/bcuwptheme/html2canvas.js"></script>
            ...
            <script src="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/application.js"></script>
	...
	<body class="page page-id-42 page-template page-template-index-mqc-rev-php" data-spy="scroll" data-target=".sidebar-nav">

  	<div class="container" id="top-bar">
    	<div class="row">
    		<div id="top-logo" class="span12">
  				<a href="http://www.ncoa.org" target="_blank"><img src="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/images/ncoa-logo-top.png" alt="National Council on Aging" title="National Council on Aging"></a>
    		</div>
        </div>    
   </div>
	...
	<div class="container" id="header">
    	<div class="row">    
    		<div id="header_logo" class="span10">
	              <a href="http://www.mymedicarematters.org" target="_blank"><img src="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/images/mmm-logo.png" alt="My Medicare Matters" title="My Medicare Matters" /></a>
	     	</div>
    	</div>
     </div>
     <div class="container">      
...
<div class="whitewell"><form  name="esiForm" id="esiForm" action="https://medicarequickcheck.benefitscheckup.org/screening-contact/" method="post" > 
<fieldset>

<div  class=" "></div>
<div></div>
        <label>First Name (Medicare Beneficiary):</label>
        <input name="first_name" required="required"  type="text" value="">
  
  
  <div>
        <label>Middle Name (Medicare Beneficiary):</label>
        <input name="middle_name" type="text" value="">
...
<div  class=" "></div>
        ...
        <input name="last_name" required="required"  type="text" value="">
  </div>
  <div>
<div  class=" "></div>
<div></div>
        <label>Date of Birth (MM/DD/YYYY):</label>
        <input name="dob" required="required"  type="text" value="">
  </div>
...
<div class=" "></div>
        ...
        <input name="zip_code" required="required" pattern="[0-9]*"  type="text"  value="">
  </div>
  <div>
...
<div></div>
        ...
        <input name="phone_number" required="required"   type="text" value="">
  </div>
<div  class=" "></div>
<div>
<div></div>
        <label>Confirm Phone (XXX) XXX-XXXX (Medicare Beneficiary or Form Completer):</label>
        <input name="confirm_phone" required="required"   type="text" value="">
  </div>
 <div>
<div  class=" "></div>
...
<div  class=" "></div>
        ...
        <input name="confirmemail" type="email" value="">
<div  class=" "></div>
...
<input type="hidden" name="submitted" value="true"><input type="submit" name="submit"  >
...
<div align=left>
       ...
       <p>If you&#8217;d like to speak to a licensed insurance agent from <strong>Aon Retiree Health Exchange&#0153;</strong>, call: 800-555-1212 (TTY Dial 888-555-1212).</p>
       ...
       <p><a href="https://www.mymedicarematters.org/about/ncoa-mymedicarematters-aon-hewitt-navigators/" target="_new">Learn more</a> about Aon Retiree Health Exchange and why NCOA recommends them.</p>
        ...
        <div class="container" id="footer">
        	<div class="row">
				...
				<div class="span3">
			        <a target="_new" href="http://www.ncoa.org/"><img src="https://medicarequickcheck.benefitscheckup.org/wp-content/themes/bcuwptheme/images/BCUfooter-ncoa-logo.png" alt="National Council on Aging" title="National Council on Aging"></a>
			    </div>
