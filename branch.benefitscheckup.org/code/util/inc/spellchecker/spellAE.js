		...
		function spell(formName) {
			...
			ActivSpellWin = window.open(ae_inc + "window.cfm?jsvar=" + ActivSpell.fieldRefs[0], "ActivSpellWin", "height=230,width=450,status=no,toolbar=no,menubar=no,location=no");	
