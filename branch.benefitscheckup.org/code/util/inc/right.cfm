...
<cflock scope="SERVER" type="READONLY" timeout="30">
	<cfset img_data=Evaluate("Server.ae_img_#url.imagedata#")>
</cflock>

<cftry>
<cfset this.root = ListGetAt(img_data,2)>
<cfcatch type="Any">
...
<!--- output directories --->
			...
			<!--- output files --->
			<cfoutput query="dir">
			<cfif dir.name contains '.gif' OR dir.name contains '.jpg' OR dir.name contains '.jpeg' OR dir.name contains '.png'>
