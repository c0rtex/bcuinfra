...
var httpRequest;
  ...
  <div class="topheader">
  	<table width="100%"><tr><td>
       		...
       		</div><div style="float:right;"><a target="42" href="http://www.ageoptions.org"><img border="0" title="AgeOptions" alt="AgeOptions" src="/cf/img/partners/ageoptions/logo.gif"></a></div></td></tr></table>
