...
<cfparam name="PID" type="string" default="">
<cfparam name="SID" type="string" default="">  
<cfparam name="click_id" type="string" default="">  
<!---<cf_sessionLoadVars>--->
<cfif visible>
...
<cfelse>
	...
	<cfelse>
		...
		<cfif urlinfo.protocol eq ''>
			...
			<cfif click_id neq ''>
				<cfif findnocase('?',newURL) gt 0>
				 <cfset newURL = newURL & '&' & 'click_id=' & click_id >
				<cfelse>
				 <cfset newURL = newURL & '?' & 'click_id=' & click_id >
				</cfif>
			</cfif>
