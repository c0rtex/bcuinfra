	      ...
	      <section id="mobility">  	
	       ...
	       <div class="span9">
		    ...
		    <ul class="nav">
                  ...
                  <li>
                  <a class="nav-header" href="#instructions"><i class="icon-book "></i> Instructions </a>
                  </li>
		    
            <li>
            <a href="#basicinfo"><i class="icon-pencil "></i> Basics &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon-check "></i><em><strong>Completed</strong></em></a>
            </li>
