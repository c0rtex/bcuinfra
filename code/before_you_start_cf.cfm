...
<cfoutput><IMG SRC="images/elder02#imgExt#.jpg" width="139" height="139" ALIGN="Left" HSPACE="0" vspace="8" ALT="A senior man"></cfoutput>
</TD>
...
<cf_sessionPassVars action="/frmwelcome2.cfm" method="post" name="formwelcome" blocklist="#blocklist#">
...
<LI><strong><INPUT TYPE="submit" VALUE="Click Here" NAME="welcome"></strong> &nbsp;to start.<cfif session.partner_id eq 7 and session.subset_id neq 14>, get your results, and get help enrolling<cfelseif session.subset_id eq 14>, learn about your current coverage, and get our recommendations for what you should do next</cfif>.<BR>
<IMG SRC="images/pixel.gif" width="1" height="10" border="0" alt=""><BR>
...
<cfif session.subset_id eq 14 Or (Not Preserve And session.subset_id eq 19)>
	<cfif hasRadio>
<p><b>Note:</b>&nbsp; <input type="button" name="qjump" value="Click Here" onClick="this.form.subset_id[0].value = '34'; this.form.subset_id[0].checked = true; this.form.submit();"> &nbsp;if you're looking for prescription drug assistance for a person who does NOT have Medicare.</p>
	<cfelse>
<p><b>Note:</b>&nbsp; <input type="button" name="qjump" value="Click Here" onClick="this.form.subset_id.value = '34'; this.form.submit();"> &nbsp;if you're looking for prescription drug assistance for a person who does NOT have Medicare.</p>
	</cfif>
</cfif>
</cfif>
...
<p align="center">Organizational Edition users, <a href="#application.transferType#://#application.serverPath#/kaiseroe/">click here</a>.</p>
</cfoutput></cfif>
