...
<cfoutput><h2>Display Form</h2></cfoutput>
	...
	<div <cfif session.partner_id EQ 22>class="appforms"</cfif>>
		...
		<cfoutput query="appforms"> 
			...
			<cfif FindNoCase("forms/#string#", save_prg_desc) eq 0>
				...
				<strong>Click below to get application(s) and/or document(s) for this program:</strong>
				<ul>
				</cfif>
				<cfif formtype_id eq 1 or formtype_id eq 0>
				<li><a href="#application.formpath#/#appforms.string#">#tag_name#</a></li>
