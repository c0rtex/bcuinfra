...
<cf_sessionPassVars action="/frmwelcome2.cfm" subset_id="51" method="post" name="formwelcome">

<tr>
<td><p><cf_sessionPassVars href="frmwelcome2.cfm" class="h1link" prev_id="0" subset_id="51">Get Started Now!</cf_sessionPassVars></p>
<img src="img/partners/rmc/cover.jpg" alt="" align="right" hspace="12" /><p class="text1">#session.subsetText#</p>
