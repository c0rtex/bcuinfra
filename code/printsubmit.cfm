...
<cfparam name="includePrgIDs" type="boolean" default="false">
...
<cf_genAssistGuideXML includePrgIDs="#includePrgIDs#" code="#code#" prg_id="#prg_id#">
<input type="hidden" name="#code#" value="include">
