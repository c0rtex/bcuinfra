...
<cfset partner_id =29 ><!--batch partner id used to associate source and result data with partner -->
...
<cfif #len(badResponseList)# eq 0>
	...
	<cfhttp url="ssatransfer/submitApplicant.php?Screening_id=#session.screening_id#" method="get"  >
	</cfhttp>
