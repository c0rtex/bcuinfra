...
<cfelse>
	...
	<cfif not debugOutput><cfabort>
		<cflocation url="frmeligibility.cfm?rpt=#rpt#" addtoken="Yes">
	<cfelse>
		<br><br><cfoutput><a href="frmeligibility.cfm?cfid=#session.cfid#&cftoken=#session.cftoken#&rpt=#rpt#">continue</a></cfoutput>
	</cfif>
</cfif>
