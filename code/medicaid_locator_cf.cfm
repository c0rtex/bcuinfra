<!---cfif IsDefined('SESSION.partner_id') AND SESSION.partner_id EQ 0>	
	<cfset SESSION.application_id = 1>
	<cfset SESSION.program_id = 579>
	...
	<cf_displayText group="site" code="site_mdcd_locator_intro_language_office_page" var="site_mdcd_locator_intro_language_office_page">
		...
		<!---<p>#site_mdcd_locator_intro_language_country_map#</p>--->
	
		<!---<p>#site_mdcd_locator_intro_language_state_page#</p>--->
		
		<!--- Bug 5727 - Update Locator Titles with New Site Text --->
		<h1 align="center"><cf_displayText group="site" code="site_medicaid_locator_title"></h1>
		<p>#site_mdcd_locator_intro_language_office_page#</p>
		...
		<form action="medicaid_locator.cfm?zipSearch=1&partner_id=<cfoutput>#URL.partner_id#</cfoutput>" method="post">
		<div id="zip_code_search">
				...
				<div id="flash_map">
					<script type="text/javascript">
					AC_FL_RunContent( 'codebase','https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0','width','#mapWidth#','height','#mapHeight#','id','flashMap','align','middle','src','us_city_map/golden_usa_external?xmlfile1=us_city_map/usa.xml&show_map=#showmap#','quality','high','wmode','transparent','bgcolor','##ffffff','name','golden_usa_external','allowscriptaccess','sameDomain','pluginspage','https://www.macromedia.com/go/getflashplayer','movie','us_city_map/golden_usa_external','flashvars','xmlfile1=us_city_map/usa.xml&show_map=#showmap#' ); //end AC code
					</script>
					...
					<embed src="us_city_map/golden_usa_external.swf?xmlfile1=us_city_map/usa.xml&show_map=#showmap#&partner_id=#URL.partner_id#" quality="high" wmode="transparent" bgcolor="##ffffff" width="#mapWidth#" height="#mapHeight#" name="golden_usa_external" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/go/getflashplayer" />
					</object></noscript>
...
<cfelse--->
	...
	<cfelse>
		...
		function showOffices(url) {
			...
			$('#offices').replaceWith('<div id="offices" style="padding:8px; width:238px; background-color:#CCCCCC;"><h2 class="snapH2">Loading Office(s)</h2><p class="text1"><img src="/cf/img/loading.gif"></p></div>');
			$("#offices").css("width", "238px");		
	...
	<div class="introText" id="language_country_map" <cfif showmap GT 0>style="display:none;"</cfif>>
    	<h1 class="locatorH1" style="text-align:center; width:100%; margin-top:0px; padding-top:0px;"><cf_displayText group="site" code="site_medicaid_locator_title"></h1>
	...
	<div class="introText" id="language_office_map" <cfif showmap IS 0>style="display:none;"</cfif>>
    	<div id="snapLink" style="margin-bottom:10px; margin-right:20px; float:right;"><a class="snapLink" onclick="printpage();" href="##"><img hspace="0" border="0" vspace="0" title="Print this Page" alt="Print this Page" src="/cf/img/print_this_page.gif"></a></div>
<h1 class="locatorH1" style="text-align:#alignHeader#; width:100%; margin-top:0px; padding-top:0px;"><cf_displayText group="site" code="site_medicaid_locator_title"></h1>
    	<p class="text1" <cfif showmap GT 0>style="margin-right:24px;" </cfif>>
    ...
    <cfelse>
		<script type="text/javascript">
                AC_FL_RunContent( 'codebase','https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0','width','#mapWidth#','height','#mapHeight#','id','flashMap','align','middle','src','us_city_map/golden_usa_external?xmlfile1=us_city_map/usa_pl.xml&show_map=#showmap#','quality','high','wmode','transparent','bgcolor','##ffffff','name','golden_usa_external','allowscriptaccess','sameDomain','pluginspage','https://www.macromedia.com/go/getflashplayer','movie','us_city_map/golden_usa_external','flashvars','xmlfile1=us_city_map/usa_pl.xml&show_map=#showmap#' ); //end AC code
                </script>
                
                <noscript><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="https://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=8,0,0,0"  width="#mapWidth#" height="#mapHeight#" id="flashMap" align="middle">
                <param name="allowScriptAccess" value="sameDomain" />
                <param name="movie" value="us_city_map/golden_usa_external.swf" />
                <PARAM NAME=FlashVars VALUE="xmlfile1=us_city_map/usa_pl.xml&show_map=#showmap#">
                <param name="quality" value="high" />
                <param name="wmode" value="transparent" />
                <param name="bgcolor" value="##ffffff" />
                <embed src="us_city_map/golden_usa_external.swf?xmlfile1=us_city_map/usa_pl.xml&show_map=#showmap#&partner_id=#URL.partner_id#" quality="high" wmode="transparent" bgcolor="##ffffff" width="#mapWidth#" height="#mapHeight#" name="golden_usa_external" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="https://www.macromedia.com/go/getflashplayer" />
                </object></noscript>
   	</cfif>
	</center>
	</td>
