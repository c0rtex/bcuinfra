...
<cfif Find("index.cfm", BasePath) or Find("before_you_start.cfm", BasePath)>
	<cfset title="BenefitsCheckUp for Coventry Health Care - NCOA's Online Screening Service">
	<cfset AddBanner = "Yes">
<cfelse>
	<cfset title="BenefitsCheckUp for Coventry Health Care">
	<cfset AddBanner="No">
</cfif>
<!-- set table values -->
<cfset tablewidth="95%">
...
<cfif Find("index.cfm", BasePath) or Find("before_you_start.cfm", BasePath)>
	<cfparam name="title" default="BenefitsCheckUp for Coventry Health Care - NCOA's Online Screening Service">
	<cfset AddBanner = "Yes">
<cfelse>
	<cfparam name="title" default="BenefitsCheckUp for Coventry Health Care">
	<cfset AddBanner="No">
</cfif>
...
<cfif link IS NOT "" OR session.org_id IS NOT 0 OR (session.partner_id IS 19 AND attributes.showmenu IS 0)><cfelse>
	...
	<cfif attributes.showmenu IS 1>
		<div class="asof1">
		<span class="asofh2"><a href="http://www.coventryadvantra.net" target="Coventry"><img src="img/partners/coventry/CoventryLogo.gif" border="0" alt="Coventry Health Care"></a>
		</span>
		</div>
