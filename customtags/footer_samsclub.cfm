...
<cfelse>
	<div class="footer">
	<div class="container2"><div class="footer1">&copy; #year(now())# <a href="http://www.ncoa.org" class="footerlink" target="ncoa">National Council on Aging.</a> All rights reserved.</div>
	<div class="footer2">
	...
	<cfelse>
	 ...
	 <!---<a id="link_to_us" href="javascript:linkToUs('/link_to_us.cfm')" class="footerlink">Link to Us</a> / ---><a id="privacy" class="footerlink" href="/privacy.cfm">Privacy Policy</a> / <a class="footerlink" id="terms" href="/terms.cfm">Terms of Use</a> / <a class="footerlink" href="mailto:#request.comments_address#">Feedback</a>
		...
		<!---<div id="disclaimer">
		<cf_displayText code="site_samsclub_disclaimer" group="site">
	</div>--->
	</div>
</cfif>
</cfif>
