...
<cfparam name="attributes.showwalmart" type="boolean" default="true">
...
find over <strong>$1.1 billion</strong> in SNAP benefits.</p>
	...
	<cfif 1 eq 1 ><img src="/cf/img/partners/seniorhunger/logo.gif" title="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" alt="NCOA's Senior SNAP Initiative, in partnership with the Walmart Foundation" style="float: right; padding-top: 20px;"/></cfif>
