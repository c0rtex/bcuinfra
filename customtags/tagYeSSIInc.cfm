...
<cfif SESSION.MARITAL_STAT EQ "Married">
	...
	<cfif SESSION.S_SP_INCOME_TANF EQ ''>
		<cfset SESSION.S_SP_INCOME_TANF = 0>
	</cfif>
	<cfif SESSION.S_SP_INCOME_CASH_ASSIST EQ ''>
		<cfset SESSION.S_SP_INCOME_CASH_ASSIST = 0>
	</cfif>
...
<cfelse>
	...
	<cfif SESSION.S_INCOME_TOTAL_UNEARNED eq "">
