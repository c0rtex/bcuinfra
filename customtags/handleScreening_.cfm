...
<!--- START action:  log the start of a screening and initialize structure --->
	...
	<cfif attributes.mode neq 'print'>
		...
		<cf_cacheAnswerfieldPool action="get" var="afpool">
		<cf_loopPoolStruct struct="afpool" index="af">
		...
		<!--- This query is good and updated, but needs to be cached --->
		<cfquery name="getExplicitAnswerfields" datasource="#application.dbSrc#">
	...
	<cfif attributes.mode neq 'print'>
		<cfquery name="getRequiredAFs" datasource="#application.dbSrc#">
		...
		<cfelse>
			<cfquery name="getPrevScreening" datasource="#application.dbSrc#">
