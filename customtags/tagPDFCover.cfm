...
<cfelse>
<CENTER>Your <b><cfif session.partner_id eq 22 and session.subset_id eq 70>Benefits<cfelse><cf_tagBCU></cfif></b> Report</CENTER>
</FONT><BR>

<!---<CENTER><FONT size=3 face="Arial"><B>A personalized report of benefits that may be available to you</B></FONT></P></CENTER>---><br>
</cfif>

<!---cfif IsDefined('application.partnervars') AND session.partnerPDFLogoFlag and StructKeyExists(application.partnervars, "p#session.partner_id#") and FileExists(ExpandPath("http://#application.serverPath#/cf/img/partners/#StructFind(application.partnervars, "p#session.partner_id#")#/logo.gif"))>
...
<cfquery name="partnercode" datasource="#application.dbSrc#">
Select partner_code from tbl_partner where partner_id = #session.partner_id#
</cfquery>
<cfset partnerfolder = '#partnercode.partner_code#'>
...
<center><IMG src="https://#application.serverPath#/cf/img/partners/#partnerfolder#/logo.png" border="0" ALT="Logo"></center><br /><br /><br /><br /><br />
	...
	<cfelse>
		<center><IMG src="https://#application.serverPath#/cf/img/partners/#partnerfolder#/logo.gif" border="0" ALT="Logo"></center><br /><br /><br /><br /><br /><br />
	</cfif>
<cfelseif session.partner_id eq 22 and session.partnerPDFLogoFlag>
<center><IMG src="https://#application.serverPath#/cf/images/logo_print_aarpfound2.jpg" width="239" height="80" border="0" ALT="AARP Foundation"></center><br /><br /><br /><br /><br />
<cfelseif session.partner_id eq 28 and session.partnerPDFLogoFlag>
<center><IMG src="https://#application.serverPath#/cf/images/logo_print_windsor.gif" width="205" height="60" border="0" ALT="Windsor Medicare Extra"></center><br /><br /><br /><br /><br /><br />
<cfelseif session.partner_id eq 30 and session.partnerPDFLogoFlag>
<center><IMG src="https://#application.serverPath#/cf/images/logo_print_coventry.gif" width="205" height="60" border="0" ALT="Coventry Healthcare Logo"></center><br /><br /><br /><br /><br /><br />
<cfelseif session.partner_id eq 120 and session.partnerPDFLogoFlag>
<center><IMG src="https://#application.serverPath#/cf/images/HPP Logo PL.png" width="260" height="60" border="0" ALT="Coventry Healthcare Logo"></center><br /><br /><br /><br /><br /><br />
</cfif>

<cfif session.partner_id eq 14>
<center><IMG src="https://#application.serverPath#/cf/img/partners/mmm/logo.png"  border="0" ALT="My Medicare Matters"></center><br /><br /><br /><br /><br /><br />
</cfif>
...
<IMG src="https://#application.serverPath#/cf/img/ncoa-logo.gif" border="0"></CENTER><BR><cfif attributes.localversion neq "cookcountyillinois"></cfif>
