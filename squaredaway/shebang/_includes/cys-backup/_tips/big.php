							<table class="spending-table table-lined">
								...
								<tbody class="table-body y-scroll">
									...
									<tr class="add-todo row-2">
										<td class="checkbox-container">
											<input type="checkbox" name="sell" value="Sell a car" class="checkbox-input"></td>
										<td>
										<label for="sell" class="checkbox-label">Sell a car.</label></td>
										<td class="spending-savings"><span class="dollar">$</span>500</td>
									</tr>
									...
									<tr class="add-todo row-4">
										<td class="checkbox-container">
											<input type="checkbox" name="atm" value="Avoid new cars. Because cars are made better now than they used to be, buying used isn&rsquo;t as risky." class="checkbox-input"></td>
										<td class="tip-trigger">
											<label for="atm" class="checkbox-label">Avoid new cars.</label><div class="tooltip">Because cars are made better now than they used to be, buying used isn&rsquo;t as risky.</div></td>
										<td class="spending-savings"><span class="dollar">$</span>225</td>													</tr>
									...
									<tr class="add-todo row-6">
										<td class="checkbox-container">
											<input type="checkbox" name="mpg" value="Get car with higher mpg and lower insurance cost" class="checkbox-input"></td>
										<td>
										<label for="mpg" class="checkbox-label">Get car with higher mpg and lower insurance cost.</label></td>
										<td class="spending-savings"><span class="dollar">$</span>100</td>							
									</tr>
			
									<tr class="add-todo row-7">
										<td class="checkbox-container">
											<input type="checkbox" name="tap" value="Carpool" class="checkbox-input"></td>
										<td>
									...
									<tr class="add-todo row-9">
										<td class="checkbox-container">
											<input type="checkbox" name="grants" value="Use grants, scholarships, work-study programs for your education." class="checkbox-input"></td>
										<td>
										<label for="grants" class="checkbox-label">Use grants, scholarships, work-study  for education.</label></td>
										<td class="spending-savings"><span class="dollar">$</span>40</td>							
									</tr>
			
									<tr class="add-todo row-10">
										<td class="checkbox-container">
											<input type="checkbox" name="public" value="Use public schools instead of private ones." class="checkbox-input"></td>
										<td>
										<label for="public" class="checkbox-label">Use public schools instead of private ones.</label></td>
										<td class="spending-savings"><span class="dollar">$</span>2,000</td>							
									</tr>
