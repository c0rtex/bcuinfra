...
<input type="hidden" value="100000" id="ret_savings" />
...
<section class="drawdown-option-section">
	<div id="note-container" class="note-advanced note-drawdown-options"><p>Click an option to see how it draws from Savings</p><div class="note-arrow"><span class="right"></span></div></div>
