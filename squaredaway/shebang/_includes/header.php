...
<div class="container-fluid">
        ...
        <div id="header" class="row-fluid">
	        <div class="span5" >
	        	<a href="http://www.ncoa.org/enhance-economic-security/economic-security-Initiative/" target="_new" ><img src="/wp-content/themes/shebang/_images/_logos/EconomicCheckUp_NCOA_small.jpg" 
	...
	<div id="main-nav" class="navbar row-fluid">
		<ul id="home-nav" class="row-fluid">
			<li id="esi-home" class="span2"><a class="<?php echo $_home; ?>" href="https:/redesign.benefitscheckup.org/esi-home">Home</a></li>
			<li id="esi-spq" class="span2"><a href="https:/redesign.benefitscheckup.org/esi-questions" class="<?php echo $_spq; ?>">Get&nbsp;Started</a></li>
		    <li id="esi-help" class="span2"><a href="https:/redesign.benefitscheckup.org/esi-find-help" class="<?php echo $_help; ?>">Find&nbsp;Help</a></li>
