<?php 
	// include('action-menu-todos.php');
?>

<script type='text/javascript'>

	var body = $('body');
	body.addClass('where-people-spend-2');
</script>
							...
							<?php
								...
								foreach($sections as $section){
									...
									foreach($section->children as $child){
										...
										echo '<h3 class="spending-cat-h1">';
										// echo '<a href="#'.$child->slug.'" class="more-link">';
...
//print_r($child);
										...
										// echo '<a href="#'.$child->slug.'"><span class="spending-cat-more-text">More</span></a>';
										echo "Click tab on left for more choices";
				...
				<?php
					...
					foreach($sections as $section){
						foreach($section->children as $child){
							...
							echo '<h3 class="spending-cat-h1">';
							//echo '<a href="#'.$child->slug.'">';
							echo '<img class="spending-cat-icon" src="'.get_bloginfo('stylesheet_directory').'/_images/icon-'.$child->slug.'-25x25.png" />'.$child->name;
							//echo '</a>';
							echo '</h3></header>';
