				...
				<table class="todo-table">
					...
					<tbody class="todo-table-body">
						...
						<tr class="checkoff-todo row-1">
							...
							<td class="todo-type">
								<label for="spend-less" class="checkbox-label">
								Revisit This Planner Next Year, as Things Change</label></td>
							<td class="todo-link"><a href="/planners/savings-as-a-source-of-retirement-income/" class="arrow-button-small">Do It &raquo;</a>
								</td>
						</tr>
			...
			<article class="todo-cys todo-section">
				...
				<table class="todo-table">
					...
					<tbody class="todo-table-body">
						...
						<!--<tr class="checkoff-todo row-1">
							<td class="checkbox-container">
								<input type="checkbox" id="downsizing-options" name="downsizing-options" value="Plan How You Can Spend Less and Save More" class="checkbox-input"></td>
							<td class="todo-type">
								<label for="downsizing-options" class="checkbox-label">
								Learn more about downsizing options</label></td>
							<td class="todo-link">
								<a href="/learn-more/move-or-stay-put/" class="arrow-button-small">Learn More &raquo;</a></td>
						</tr>-->
