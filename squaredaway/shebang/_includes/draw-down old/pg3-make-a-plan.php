...
<section class="drawdown-option-table">
	<table class="option-table">
		<thead>
			<tr class="option-table-hdr">
				<th class="option-name-th">Strategy</th>
				<th class="option-slider-th">Percent of Savings You'll Use</th>
				<th class="option-slider-amount-th">&nbsp;</th>
				<th class="option-intial-savings-th">Initial Savings</th>
				<th class="option-initial-income-th">Initial Income</th>
			</tr>
		</thead>		
		...
		<tbody>
			<tr class="int-abv-row">
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="interest_above_inflation_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="interest_above_inflation_initial_income">0</span>
				</td>
			</tr>
			<tr class="set-amt-row">
				<td class="option-name">
					<h3 class="option-name-h">Draw a Set Amount</h3>
					<fieldset class="form-field-tiny set-amt-fieldset">
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="set_amount_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="set_amount_initial_income">0</span>
				</td>
			</tr>
			<tr class="set-pct-row">
				<td class="option-name">
					<h3 class="option-name-h">Draw a Set Percentage</h3>
					<fieldset class="form-field-tiny set-pct-fieldset">		
						...
						<label class="field-mod-txt" for="set_percentage_plan">of whatever your savings happen to be</label>
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="set_percent_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="set_percent_initial_income">0</span>
				</td>
			</tr>
			<tr class="rqd-row">
				<td class="option-name">
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="rmd_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="rmd_initial_income">0</span>
				</td>
			</tr>
			<tr class="annuity-row">
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="inflation_proof_annuity_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="inflation_proof_annuity_initial_income">0</span>
				</td>
			</tr>
			<tr class="delay-ss-row">
				<td class="option-name">
					<h3 class="option-name-h">Use Savings to Delay Claiming Social Security</h3>
	<!-- 				<input type="checkbox" name="delay_claiming_selected" id="delay_claiming_selected" value="0" /> Select this option -->
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="delay_claiming_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="delay_claiming_initial_income">0</span>
				</td>
			</tr>
			<tr class="annuity-85-row">
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="alda_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="alda_initial_income">0</span>
				</td>
			</tr>
			<tr class="total-row">
				<td class="option-name">
				...
				<td class="option-initial-savings option-fig">
					<span class="dollar">$</span><span id="total_initial_savings">0</span>
				</td>
				<td class="option-initial-income option-fig">
					<span class="dollar">$</span><span id="total_initial_income">0</span>
				</td>
			</tr>
		</tbody>
	</table>
...
<div class="frame-title-container"><p class="frame-title">What To Do Next &hellip;</p></div>
	<ul class="what-next-list">
		<li class="what-next-item"><h2 class="what-next-h">If You Don't Have Enough: <a href="options-if-you-dont-have-enough">Learn About Your Options &raquo;</a> </li>
