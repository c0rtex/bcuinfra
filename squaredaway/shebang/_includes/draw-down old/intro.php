		...
		<article class="frame" data-nav="Introduction">
				...
				<ul id="drawdown-intro-list" class="intro-list">
					<li class="col-1 drawdown-intro-item intro-item first">
						<a class="intro-link" href="'.get_next_slide_link().'"><img class="intro-img" src="<?php echo get_template_directory_uri(); ?>/_images/_icons/target.png"></a>
						<?php
					...
					<li class="col-2 drawdown-intro-item intro-item">
						<a class="intro-link" href="'.get_next_slide_link().'"><img class="intro-img" src="<?php echo get_template_directory_uri(); ?>/_images/_icons/annuities.png"></a>
						<?php
					...
					<li class="col-3 drawdown-intro-item intro-item last">
						<a class="intro-link" href="'.get_next_slide_link().'"><img class="intro-img" src="<?php echo get_template_directory_uri(); ?>/_images/_icons/checklist.png"></a>
						<?php
