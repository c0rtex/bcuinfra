		...
		<!-- /* REM 2013-09-13: We're closing the wrapper container here  */ -->
		</div>
	</div>
</div>
        	...
        	<div class="sub-wrapper">
            	<div id="bcu" class="span2">
					<h2>EconomicCheckUp:</h2>
						<ul>
							<li><a href="https://www.benefitscheckup.org/esi-questions">My CheckUp</a></li>
							<li><a href="https://www.benefitscheckup.org/esi-find-help">Resources</a></li>
							<li><a href="https://www.benefitscheckup.org/esi-about">About Us</a></li>
							<li><a href="https://www.benefitscheckup.org/esi-news">News</a></li>
							<li><a href="http://www.ncoa.org/Donate" target="_blank">Donate</a></li>
							<li><a href="https://www.benefitscheckup.org/esi-privacy-policy/">Privacy Policy</a></li>
							<li><a href="https://www.benefitscheckup.org/esi-termsofuse/">Terms of Use</a></li>
							<li><a href="https://www.surveymonkey.com/s/3V39M9Z">Feedback</a></li>
							<li><a href="mailto:economiccheckup@ncoa.org">Contact Us</a></li>
							<li><a target =_blank href="https://oe.benefitscheckup.org/?partner_id=77">Partner Login</a></li>
						</ul>
				</div>
...
<li><a href="http://www.ncoa.org/national-institute-of-senior-centers/" target="_blank">National Institute of Senior Centers</a></li>
					...
					<h2>Press Room:</h2>
						<ul>
							...
							<li><a target="_blank" href="https://www.ncoa.org/news/">Press Releases</a></li>
...
-->
	...
	<li class="cr"><a target="_blank" href="http://www.ncoacrossroads.org">Crossroads Community for Professionals in Aging</a></li>
        ...
        <div id="footer-primary">
				...
				<div class="span12">
			        <a target="_new" href="http://www.ncoa.org/"><img src="<?php echo get_template_directory_uri(); ?>/_images/_logos/BCUfooter-ncoa-logo.png" alt="NCOA" title="NCOA"></a><br />
...
<p class="esiFooter">251 18th Street South &nbsp;| &nbsp;Suite 500 &nbsp;| &nbsp;Arlington, VA 22202 &nbsp;|&nbsp; 571-527-3900</p>
	...
	<!-- REM - These references have been moved down from the header file so they're all loading together in the footer -->
	<!-- scripts that don't appear to be relevant for the calculator pages 
	<script type='text/javascript' src='/cf/js/infinite-rotator.js'></script> -->
    <!-- <script type="text/javascript" src="/wp-content/themes/shebang/js/jquery-latest.js"></script> -->
    <script type="text/javascript" src="/wp-content/themes/shebang/js/scrolltofixed.js"></script>
    <!-- <script type="text/javascript" src="/wp-content/themes/shebang/bootstrap/js/jquery.js"></script> -->
    <script type="text/javascript" src="/wp-content/themes/shebang/bootstrap/js/jquery.validate.js"></script>
	...
	<script type="text/javascript" src="https://www.benefitscheckup.org/CFIDE/scripts/cfform.js"></script>
    ...
    <!--[if lt IE 9]>
      <script src="/wp-content/themes/shebang/bootstrap/js/html5shiv.js"></script>
    <![endif]-->
	...
	<!-- REM - These references are included from the SA footer and footer-close file - not sure which of them are needed for the children pages to function, so we're 
	including everything for now -->
	...
	<script type="text/javascript" src="/wp-content/themes/shebang/js/jquery.scrollTo-min.js"></script>
	<script type="text/javascript" src="/wp-content/themes/shebang/js/jquery.localscroll.js"></script>
	<script type="text/javascript" src="/wp-content/themes/shebang/js/tito-base.js"></script>
	<script type="text/javascript" src="/wp-content/themes/shebang/js/ari.js"></script>
	<script type="text/javascript" src="/wp-content/themes/shebang/js/shebang-site.js"></script>
	...
	<script type='text/javascript' src='/wp-content/plugins/upstatement-admin/upstatement-admin.js?ver=3.3.1'></script>
