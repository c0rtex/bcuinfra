...
<section>
  <ul class="profile-list">
    ...
    <li class="categoreis"><strong>Benefits Categories: </strong>
        <span class="ng-binding ng-scope">Medication</span>
        <span class="ng-binding ng-scope">Health Care</span>
        <span class="ng-binding ng-scope">Income Assistance</span>
        <span class="ng-binding ng-scope">Food &amp; Nutrition</span>
        <span class="ng-binding ng-scope">Housing &amp; Utilities</span>
        <span class="ng-binding ng-scope">Tax Relief</span>
        <span class="ng-binding ng-scope">Veterans</span>
        <span class="ng-binding ng-scope">Employment</span>
        <span class="ng-binding ng-scope">Transportation</span>
        <span class="ng-binding ng-scope">Education</span>
        <span class="ng-binding ng-scope">Discount</span>
        <span class="ng-binding ng-scope">Other Assistance</span>
    </li>
  </ul>
</section>
